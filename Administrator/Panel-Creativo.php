...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Panel Creativo Modasof</title>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Panel-Creativo.php">Área de Creación</a>
							</li>
							<li>
								<i class="ace-icon fa fa-dashboard"></i>
								<a href="Panel-Creativo.php">Reporte</a>
							</li>
						</ul><!-- /.breadcrumb -->
				...
				?>
						...
						<div class="col-xs-12 col-sm-12 center">
							...
							<div class="infobox" id="botonoculto">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"> CREAR REF.</span>
							...
							<div class="infobox" id="botonoculto">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"> GALERIA</span>
												<!-- <div class="infobox-content"><a href="Entradas.php">Total Gastos</a></div> -->
											</div>
						...
						<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Ord. Corte Semana</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-verdeligth"><strong>12 SOLICITADAS <br>4 PENDIENTES</strong></div>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Ordenes Semana Anterior</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-verdeligth"><strong>45 SOLICITADAS <br>2 PENDIENTES</strong></div>
													</div>
												</div>
											</div>
										</div>
					<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Total Insumos Mes</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-verdeligth"> <strong>$4.500.000 A CRÉDITO  <br>$0 EN EFECTIVO</strong></div>
													</div>
												</div>
											</div>
										</div>
					<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Total Insumos Mes Anterior</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-verdeligth"> <strong>$9.500.000 A CRÉDITO  <br>$3.000.000 EN EFECTIVO</strong></div>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="col-sm-12 col-xs-12">
							...
							<div class="col-sm-6 col-xs-12">
								...
								<div id="grafica" style="width: 600px; height: 350px;">
