...
<!-- build:js jquery.tinycircleslider.js -->
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==3) {
        echo "<script>jQuery(function(){swal(\"¡Lo Sentimos!\", \"Ya hay alguien logueado con ese usuario\", \"error\");});</script>";
    };
...
?>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="index.php">Inicio <?php //Echo($mensaje); ?></a>
							</li>
	...
	<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1280px;height:70px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" style="position:absolute;top:0px;left:0px;background:url('img/loading.gif') no-repeat 50% 50%;background-color:rgba(0, 0, 0, 0.7);"></div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1280px;height:70px;overflow:hidden;">
          
           <div class="infobox infobox-green col-xs-12">
											<div class="infobox-icon">
												<i class="ace-icon fa fa-dollar"></i>
											</div>

											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo Formatomoneda(87000) ?></span>
												<div class="infobox-content"> Capital Sin Aprobar</div>
											</div>

											<div class="stat stat-success">0%</div>
										</div>

           <div class="infobox infobox-red col-xs-12">
											<div class="infobox-icon">
												<i class="ace-icon fa fa-dollar"></i>
											</div>

											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo Formatomoneda(90000) ?></span>
           ...
           <div class="infobox infobox-green col-xs-12">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo Formatomoneda(97777) ?></span>
												<div class="infobox-content"> Capital Disponible</div>
											</div>
           ...
           <div class="infobox infobox-green col-xs-12">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo Formatomoneda(88999) ?></span>
            ...
            <div class="infobox infobox-green col-xs-12">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo Formatomoneda(766686) ?></span>
												<div class="infobox-content"> Total en Activos</div>
											</div>
             ...
             <!-- <div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">$ 32.000.000</span>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $_SESSION['expire'];?></h3>

              <p>New Orders<?php echo $_SESSION['start'];?></p>
            </div>
            <div class="icon">
...
document.writeln('Tu IP es: "' + ip + '"')
      ...
      <!-- /.row -->
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      <img width="48" height="48" src="http://localhost/Modasof/Administrator/Images/Perfiles/8689-logoTek.png" alt="User Image">
		...
		<div class="viewport">
			<ul class="overview">
				<li><a href="http://www.baijs.com"><img class="responsive" width="280" height="280" src="http://Modasofaute.net/Administrator/Images/Galeria-Produccion/60726-Camisa.jpeg" /></a></li>
				<li><a href="http://www.baijs.com"><img class="responsive" width="280" height="280" src="http://Modasofaute.net/Administrator/Images/Galeria-Produccion/33203-9AA41EB6-CCC9-4699-B2DE-7198768B3CB1.jpeg" /></a></li>
				<li><a href="http://www.baijs.com"><img class="responsive" width="280" height="280" src="http://Modasofaute.net/Administrator/Images/Galeria-Produccion/33203-9AA41EB6-CCC9-4699-B2DE-7198768B3CB1.jpeg" /></a></li>
				<li><a href="http://www.baijs.com"><img class="responsive" width="280" height="280" src="http://Modasofaute.net/Administrator/Images/Galeria-Produccion/33203-9AA41EB6-CCC9-4699-B2DE-7198768B3CB1.jpeg" /></a></li>
				<li><a href="http://www.baijs.com"><img class="responsive" width="280" height="280" src="http://Modasofaute.net/Administrator/Images/Galeria-Produccion/33203-9AA41EB6-CCC9-4699-B2DE-7198768B3CB1.jpeg" /></a></li>
			</ul>
