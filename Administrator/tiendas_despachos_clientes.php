...
<!-- Small boxes (Stat box) -->
						...
						<div class="col-sm-12 col-xs-12"><!-- Panel 2  -->
						  ...
						  <h5 class="page-header">Seleccionar Tienda a consultar despacho a clientes</h5>

      <div class="row">
    <?php
    if ($IdRol==1){
        $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad";
    } else {
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    ...
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                 	...
                 	<a href="listado_recepcion_clientes.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
