...
$Datos="Ingreso a Envios de Despacho Nro ".$id_despachos;
$Paginas= $_SERVER['PHP_SELF'];
$seguridad = AgregarLog($IdUser,$Datos,$Paginas);

/* REALIZA LA SUMA DEL INVENTARIO ENVIADO*/
$consulta_inventario ="SELECT  sum(valor_total) as suma,id_tienda,id_ref,img_ref,cod_ref,detalle_ref,nom_tienda,talla_id,cantidad,valor_unidad,valor_total,talla,id_user FROM t_temporal_inventario WHERE id_despacho='".$id_despachos."' and status_recibido='ENVIADO'";
		...
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				<li>
					...
					<a href="listados_envios.php">Atras</a>
				</li>
			</ul><!-- /.breadcrumb -->						
		</div>
							...
							<table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
												<thead>
													<tr class="warning">
                                                        ...
                                                        <th class="tdcustom" style="width: 5%;">Nombre Cliente</th>
													</tr>
												...
												<tbody>
<?php 
	$consulta_inventario ="SELECT  * FROM t_temporal_inventario WHERE id_despacho='".$id_despachos."' and status_recibido='ENVIADO'";
...
?>
						...
						<!-- FIN TABLA -->
<div class="center">
<form method="post" action="codigos_barra.php" id="FormOrden">
