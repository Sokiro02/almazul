			...
			<div class="main-content">
				...
				?>
						<div class="row">
							...
							<a  href="Panel-Produccion.php" class="col-sm-2 col-xs-12">
							...
							<a href="Produccion.php" class="col-sm-2 col-xs-12">
							<div class="infobox" id="botonoculto">
							...
							<a href="Proveedores.php" class="col-sm-2 col-xs-12">
							<div class="infobox" id="botonoculto">
							...
							<a href="insumos.php" class="col-sm-2 col-xs-12">
							...
							<a href="Compras.php" class="col-sm-2 col-xs-12">
							<div class="infobox" id="botonoculto">
...
?>			
									...
									<div class="form-group">
												...
												<select class="chosen-select input-xxlarge" name="TxtColor" data-placeholder="Seleccionar...">
														<option value="">Seleccionar...</option>
														<?php
$sql ="SELECT Nom_Color FROM t_colores order by Nom_Color ASC";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    	$Nom_Color=$row['Nom_Color'];             
    	echo ("<option value='".$Nom_Color."'>".utf8_encode($Nom_Color)."</option>");
 }
}
