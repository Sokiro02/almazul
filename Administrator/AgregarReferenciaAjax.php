...
if ($ValueCod!="") { // Validamos si llega un CÃ³digo
	$sql ="SELECT Cod_Temporal From t_temporal_ref WHERE Cod_Temporal='".$ValueCod."'"; // Consulta para confirmar si estÃ¡ agregado
//Echo($sql);
...
{
	Echo("<tr><td colspan='5'>No ha seleccionado ningun Insumo</td></tr>");
}
// Fin de la Consulta 
?>
 <tr>  
            <td class="success" style="font-weight: bold;"  colspan="4" align="right">Proyeccion de Costo (Insumos):</td>  
          <td class="success" style="font-weight: bold;" ><?php Echo(Formatomoneda(TotalInsumosAgregados($IdUser))) ?><span id="total_price"></span></td>  
                </tr> 
<?php
}
else // CÃ³digo ya estÃ¡ incluido en la tabla
{
...
} // Fin de validaciÃ³n de variable buscada en la base
...
$Validacion=$_POST['Validacion']; // Variable enviada desde Producto-Crear.php para verificar si ya se tiene una referencia en proceso de creaciÃ³n.

if ($Validacion!="") { //ValidaciÃ³n de variable al cargar la pÃ¡gina
...
{
	Echo("<tr><td colspan='5'>No ha seleccionado ningÃºn Insumo</td></tr>");
}
?>
 <tr>  
                     <td class="success" style="font-weight: bold;"  colspan="4" align="right">ProyecciÃ³n de Costo (Insumos):</td>  
...
<?php
} //Fin ValidaciÃ³n de variable al cargar la pÃ¡gina

$idDelete=$_POST['id'];

	if ($idDelete!="") {
		// Eliminamos el cÃ³digo 
