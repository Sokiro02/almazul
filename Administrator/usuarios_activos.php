...
$Datos="Ingreso a Usuarios Activos";
...
background: #8e24aa;
  ...
  $Valide=$_GET['Cerrar'];
  if ($Valide!=""){
    $sql="DELETE FROM t_usuarios_activos WHERE Id_Usuario='".$Valide."'";
    $resultado=$conexion->query($sql);
    if ($resultado){
        echo "<script>jQuery(function(){swal(\"¡Cerrar Sessión!\", \"Se ha cerrado correctamente la sessión del usuario\", \"success\");});</script>";
    }else{
        echo "<script>jQuery(function(){swal(\"¡Error al cerrar Sessión!\", \"NO se ha cerrado correctamente la sessión del usuario\", \"error\");});</script>"; 
    }
  }
   ?>
		...
		<div class="page-content">
			...
			<!-- Inicio botones de acceso rápido -->
                ...
                <!-- Small boxes (Stat box) -->
                    ...
                    <h5 class="page-header">Listado de Usuarios Activos en el sistema</h5>
                    <div class="row">
                        <table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                    	   <thead>
                    	       <tr class="warning">
                    					...
                    					<th class="tdcustom" style="width: 5%;">Usuario</th>
                    					<th class="tdcustom" style="width: 10%;">Nombres</th>
                    					<th class="tdcustom" style="width: 5%;">Apellidos</th>
                    					<th class="tdcustom" style="width: 10%;">Direcion IP</th>
                        ...
                        $sql="SELECT * FROM t_usuarios_activos";
                        $resultado = $conexion->query($sql);
                        if ($resultado->num_rows>0){
                            while($filas=$resultado->fetch_assoc()){
                                $id_usuario = $filas['Id_Usuario'];
                                $Ip = $filas['ip'];
                                $sql2="SELECT * FROM t_usuarios WHERE Id_Usuario='".$id_usuario."'";
                                $resultado2=$conexion->query($sql2);
                                $filas2=$resultado2->fetch_assoc();
                                $nombres = $filas2['Nombres'];
                                $apellidos=$filas2['Apellidos'];
                                $usuario=$filas2['User_Name'];
                                $imagen=$filas2['Img_Perfil'];
                                    ?>
                                <tr>
                                    <td>
                                        <?php echo $id_usuario;?>
                                    ...
                                    <td>
                						<div class=" action-buttons">
                							<a href="usuarios_activos.php?Cerrar=<?php echo($id_usuario);?>" class="tooltip-error green" data-rel="tooltip" data-placement="top" title="Cerrar Sesión">
                								<i class="ace-icon fa fa-edit bigger-110"> </i> Cerrar Sesión
                							</a>
                						</div>
                                    </td>
                                </tr>
