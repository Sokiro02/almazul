        ...
        $SumaOrden=$row['SumaOrden'];
						 ...
						 ?>
							...
							<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Formatomoneda($SumaOrden); ?></span>
												<div class="infobox-content">Total Cancelado</div>
							</div>
        ...
        $Tb_Apellidos=$row['Apellidos'];
         $Tb_Cod_Proveedor=$row['Cod_Proveedor'];
          ...
          $Tb_NombreCompleto=$Tb_Nombres." ".$Tb_Apellidos;
								...
								<a href="Proveedor-CrearOrden.php?Delete=<?php echo($Tb_Id_Orden_Compra);?>&F1=<?php echo($Recovery_F1);?>&F2=<?php echo($Recovery_F2);?>&Bod=<?php echo($Recovery_Bod);?>&NumeroOrden=<?php echo($NumeroOrden);?>&DocSel=<?php echo($DocSel);?>" class="tooltip-error red" data-rel="tooltip" data-placement="top" title="Eliminar Item">
