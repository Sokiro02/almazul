...
$ObservaId=$_GET['ObservaId'];
$valoractual=$_GET['valoractual'];

if ($ObservaId!="") { 
$HoraActualiza = date('Y-m-d H:i:s');
    $sql=("UPDATE t_actualizacion_ordenes SET Estado_Actualiza='".$valoractual."', fecha_leido='".$HoraActualiza."',leido_usuario='".$IdUser."' WHERE Id_Actualizacion_Orden='".$ObservaId."'");
   //echo($sql);
   $result = $conexion->query($sql);
   header("location:index-produccion.php?Mensaje=18");
}
...
<!-- build:js jquery.tinycircleslider.js -->
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==18) {
        echo "<script>jQuery(function(){swal(\"¡ Comentario Leído y aceptado!\", \"Correctamente \", \"success\");});</script>";
    };
    if ($Valide==2) {
      ...
      <div style="display: none;" class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <h3><?php echo("$ ".number_format(totalingresostaller($cuenta))); ?></h3>

              <p>Ingresos de Dinero</p>
            </div>
            <div class="icon">
              <i class="fa fa-money"></i>
            </div>
            <a href="#" class="small-box-footer">
              Ver Ingresos <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>
                <?php echo("$ ".number_format(totalgastostaller($MyIdTaller))); ?>

                <sup style="font-size: 20px"></sup></h3>

              <p><a style="color:white;" href="Informe-Gastosprod.php">Ver Gastos </a></p>
            </div>
            <div class="icon">
              <i class="fa fa-money"></i>
            </div>
            <a href="gastos-produccion.php" class="small-box-footer">
              Crear Gasto <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>
                <?php 
                $sumaingresos=totalingresostaller($cuenta);
                $sumagastos=totalgastostaller($MyIdTaller);
                $saldo=$sumaingresos-$sumagastos;
                echo ("$ ".number_format($saldo));
                 ?>
                <sup style="font-size: 20px"></sup></h3>

              <p><a style="color:white;" href="">Saldo</a></p>
            </div>
            <div class="icon">
              <i class="fa fa-money"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3> <?php echo("$ ".number_format(totalComprasMes($MesActual,$MyIdTaller))); ?></h3>

              <p>Compras Último Mes</p>
            </div>
            <div class="icon">
              <i class="fa fa-shopping-cart"></i>
            </div>
            <a href="Compras.php" class="small-box-footer">
              Ver Compras <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <!-- /.row -->
            ...
            <div id="tabs-1" class="tab-pane fade in active"><!-- Inicio Tab Número Uno -->
                    ...
                    <div class="table-header" style="background-color: #000;">
                      Lista de Solicitudes Ordenes de Corte
                    </div>
...
if ($MyIdTaller=="") {
  $sql ="SELECT Id_Temporal_Sol FROM t_temporal_sol Where Estado_Solicitud_Cliente<>'9' and Estado_Solicitud_Cliente<>'10' and Estado_Solicitud_Cliente<>'14' and Estado_Solicitud_Cliente<>'17' and Bodega_Id_Bodega='".$MyIdTaller."' order by Id_Temporal_Sol  DESC";
  $result = $conexion->query($sql);
...
{
  $sql ="SELECT Id_Temporal_Sol FROM t_temporal_sol WHERE Estado_Solicitud_Cliente<>'9' and Estado_Solicitud_Cliente<>'10' and Estado_Solicitud_Cliente<>'8' and Estado_Solicitud_Cliente<>'14' and Estado_Solicitud_Cliente<>'17' and Bodega_Id_Bodega='".$MyIdTaller."' and YEAR(Fecha_Solicitud)='".$AnoActual."' order by Id_Temporal_Sol  DESC";
                   ...
                   <tfoot style="display: table-header-group;">
                        ...
                        <thead>
                          ...
                          <tr class="warning">
                            ...
                            <th class="tdcustom" style="width: 7%;">Taller Asignado</th>
            ...
            ?>
             <a style="position: relative;" data-rel="tooltip" data-placement="top" title="<?php Echo utf8_encode($Ref_Completa);?>" class="image-link" href="<?php echo utf8_encode($Img_Referencia); ?>"><img src="<?php echo utf8_encode($Img_Referencia); ?>" width="45px" height="45px" >
              <?php Echo($Ref_Completa) ?>
                            ...
                            <td>
                              <?php Echo fechaSql($Fecha_Entrega); ?>
                            </td>
                            
                            <td>
                              <?php 
                              $DiasTotales=dias_transcurridos($Fecha_Solicitud,$Fecha_Entrega)+1;
                              Echo($DiasTotales) ?> Días
                            </td>
                            <td>
                             Solicitado a <?php echo($MiTaller); ?>
                            </td>
        ...
        $FechaSol=$dateSol->format('Y-m-d');
                            ...
                            <div class="itemdiv dialogdiv">
                              ...
                              <div class="body">
                                ...
                                <div class="tools">
                                  <a href="Pedido-Ver.php?PedidoCliente=<?php Echo($Pedido_Id_Pedido); ?>" class="btn btn-minier btn-info">
                                    <i class="icon-only ace-icon fa fa-share"></i>
                                  </a>
                                   <a href="index-produccion.php?ObservaId=<?php echo($Id_Actualizacion_Orden) ?>&valoractual=2" class="btn btn-minier btn-success">
