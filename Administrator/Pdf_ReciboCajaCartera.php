...
$pdf->AutoPrint();
                $pdf->Output("Facturas/ReciboCajaCartera.pdf",'F');




        echo "<script language='javascript'>window.open('Facturas/ReciboCajaCartera.pdf','_blank','');</script>";

        echo "<script language='javascript'>window.open('Clientes-AbonosCartera.php?AbonosCartera=".$AbonosFactura."','_parent','');</script>";//para ver el archivo pdf generado
