...
if ($VerificaAbonos>0) {
			header("location:Pedidoswo.php?Mensaje=28");
		}
		else{
...
header("location:Pedidoswo.php?Mensaje=18");
...
if ($ConfirmationBaja!="") {
   ...
   header("location:Pedidoswo.php?Mensaje=19");
...
function(isConfirm){
  if (isConfirm) {
    window.location.href = 'Pedidoswo.php?Confirmation=<?php Echo($NumPedidoDel);?>&VerificaAbonos=<?php Echo($ValorAbonos); ?>';
  } else {
    window.location.href = 'Pedidoswo.php';
  }
});
// swal({
...
function(isConfirm){
  if (isConfirm) {
    window.location.href = 'Pedidoswo.php?ConfirmationBaja=<?php Echo($NumPedidoBaja); ?>';
  } else {
    window.location.href = 'Pedidoswo.php';
  }
});
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Pedidoswo.php">Pedidos</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<div class="col-sm-12"><!-- Inicio Panel 12 -->
										<div class="tabbable">
											...
											<?php 
											if ($MyIdTaller!="") {
												include("listapedidos31wo.php");
											}
											elseif($IdRol==1 || $IdUser==61 || $IdUser==43)
											{
												include("listapedidos31wo.php");
											}
											else
...
$('#dynamic-table thead tr:eq(1) th').each( function () {
    ...
    "lengthMenu": [[6000, 7000, 10000, -1], [6000, 7000, 10000, "All"]],
