...
// Publicación de Líneas de Productos
$PublicLinea=$_GET['PublicLinea'];
$ValPublic=$_GET['ValPublic'];
$PublicSubCat=$_GET['PublicSubCat'];

if ($PublicLinea!="") {
	$sql="UPDATE t_categoria_producto SET Cat_Producto_Publicada='".$ValPublic."' WHERE Id_Cat_Producto='".$PublicLinea."'";
	$result = $conexion->query($sql);
	header("location:Productos-Categoria.php?Mensaje=1&TAB=tabs-1");
}

if ($PublicSubCat!="") {
	$sql="UPDATE t_subcategoria_producto SET SubCat_Producto_Publicada='".$ValPublic."' WHERE Id_SubCat_Producto='".$PublicSubCat."'";
	$result = $conexion->query($sql);
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Orden de Compra Insumos Modasof</title>
...
$("#ValNuevaLinea").keyup(function(){ //se crea la funcioin keyup
var texto = $(this).val();//se recupera el valor de la caja de texto y se guarda en la variable texto
var dataString = 'ValNuevaLinea='+ texto;//se guarda en una variable nueva para posteriormente pasarla a busqueda.php
...
return false;    
 ...
 <script type="text/javascript">
$(document).ready(function(){
$("#ValNomLinea").keyup(function(){ //se crea la funcioin keyup
var texto = $(this).val();//se recupera el valor de la caja de texto y se guarda en la variable texto
var dataString = 'ValNomLinea='+ texto;//se guarda en una variable nueva para posteriormente pasarla a busqueda.php
...
//cache: false,
success: function(html){//funcion que se activa al recibir un dato
$("#MsjError2").html(html).show();// funcion jquery que muestra el div con identificador display, como formato html, tambien puede ser .text
}
});
}
return false;    
...
<script type="text/javascript">
$(document).ready(function(){
$("#ValNuevaCategoria").keyup(function(){ //se crea la funcioin keyup
var texto = $(this).val();//se recupera el valor de la caja de texto y se guarda en la variable texto
var dataString = 'ValNuevaCategoria='+ texto;//se guarda en una variable nueva para posteriormente pasarla a busqueda.php
...
//cache: false,
success: function(html){//funcion que se activa al recibir un dato
$("#MsjError3").html(html).show();// funcion jquery que muestra el div con identificador display, como formato html, tambien puede ser .text
}
});
}
return false;    
...
<script type="text/javascript">
$(document).ready(function(){
$("#ValNomCategoria").keyup(function(){ //se crea la funcioin keyup
var texto = $(this).val();//se recupera el valor de la caja de texto y se guarda en la variable texto
var dataString = 'ValNomCategoria='+ texto;//se guarda en una variable nueva para posteriormente pasarla a busqueda.php
...
//cache: false,
success: function(html){//funcion que se activa al recibir un dato
$("#MsjError4").html(html).show();// funcion jquery que muestra el div con identificador display, como formato html, tambien puede ser .text
}
});
}
return false;    
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==1) {
        echo "<script>jQuery(function(){swal(\"¡ Línea Actualizada!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==2) {
        echo "<script>jQuery(function(){swal(\"¡ Línea de Producto Creada!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==3) {
        echo "<script>jQuery(function(){swal(\"¡ Categoria de Producto Actualizada!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==4) {
        echo "<script>jQuery(function(){swal(\"¡ Categoria Creada!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==5) {
        echo "<script>jQuery(function(){swal(\"¡ Talla Creada!\", \"Correctamente \", \"success\");});</script>";
    };
    if ($Valide==6) {
        echo "<script>jQuery(function(){swal(\"¡ Color Creado!\", \"Correctamente \", \"success\");});</script>";
    };
    if ($Valide==23) {
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Productos-Categoria.php">Configuración Productos</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<div class="col-sm-12 col-xs-12"><!-- Inicio Panel Inferior-->
										...
										<div class="tabbable">
											<ul class="nav nav-tabs" id="myTab">
												...
												<li class="dropdown">
													<a data-toggle="dropdown" class="dropdown-toggle" href="#tabs-5">
														Atributos &nbsp;
													...
													<ul class="dropdown-menu dropdown-info">
														<li>
															<a data-toggle="tab" href="#tabs-3">Tallas</a>
														</li>

														<li>
															<a data-toggle="tab" href="#tabs-4">Colores</a>
														</li>
													</ul>
												</li>
										...
										<div id="tabs-1" class="tab-pane in active">
													<a  data-toggle="modal" data-target="#myModalArea" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> Nueva Línea </i></span></a>
											<div class="clearfix">
						...
						<table  id="dynamic-table2"  class="table table-responsive table-striped table-bordered " width="100%">
											<thead>
												<tr class="blue">
													<th class="center" style="width: 5%">Prefijo</th>
													<th class="center" style="width: 5%">Línea</th>
										...
										<?php 
$sql ="SELECT Id_Cat_Producto, Cod_Cat_Producto, Nom_Cat_Producto,Cat_Producto_Publicada FROM t_categoria_producto";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Qr_IdLinea=$row['Id_Cat_Producto'];
        $Qr_PrefLinea=$row['Cod_Cat_Producto'];
        $Qr_NombreLinea=$row['Nom_Cat_Producto'];
        $Qr_LineaPublicada=$row['Cat_Producto_Publicada'];
        
         ?>
         		<form method="post" action="Productos-ActualizarLinea.php" id="FormAreas">
						<tr>

										<td class="center">
							<input type="text" class="col-xs-12" name="TxtPrefijoLinea" value="<?php echo utf8_encode($Qr_PrefLinea); ?>">
							<input style="display: none;" type="text" name="TxtIdLinea" value="<?php Echo($Qr_IdLinea)?>">
										</td>
										<td class="center">
									<input type="text" class="input-large" name="TxtNomLinea" value="<?php echo utf8_encode($Qr_NombreLinea); ?>">	
											</td>
											...
											<?php 
											if ($Qr_LineaPublicada==1) {
												?>
									<a class="green" href="Productos-Categoria.php?ValPublic=0&PublicLinea=<?php Echo($Qr_IdLinea)?>"  href=""><i class="fa fa-check"></i></a>
												<?php
											}
											else
											{
									...
									<a class="red" href="Productos-Categoria.php?ValPublic=1&PublicLinea=<?php Echo($Qr_IdLinea)?>"  href=""><i class="fa fa-close"></i></a>
												<?php
											}
											 ?>
...
?>
												...
												<div id="tabs-2" class="tab-pane">
													<a  data-toggle="modal" data-target="#myModalCategoria" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> Nueva Categoria </i></span></a>
											<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
						...
						<table  id="dynamic-table3"  class="table table-responsive table-striped table-bordered " width="100%">
											<thead>
												<tr class="blue">
													<th class="center" style="width: 5%">Prefijo</th>
													<th class="center" style="width: 5%">Categoria</th>
													<th class="" style="width: 5%">.</th>
												</tr>
											</thead>
											<tbody>
										...
										<?php 
$sql ="SELECT Id_SubCat_Producto, Cod_SubCat_Producto, Nom_SubCat_Producto,SubCat_Producto_Publicada FROM t_subcategoria_producto";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Qr_IdSubCat=$row['Id_SubCat_Producto'];
        $Qr_PrefSubCat=$row['Cod_SubCat_Producto'];
        $Qr_NombreSubCat=$row['Nom_SubCat_Producto'];
        $Qr_SubCat_Publicada=$row['SubCat_Producto_Publicada'];
        
         ?>
         		<form method="post" action="Productos-ActualizarSubCategoria.php" id="FormAreas">
						<tr>

										<td class="center">
				<input type="text" class="col-xs-12" name="TxtPrefijoSubCat" value="<?php echo utf8_encode($Qr_PrefSubCat); ?>">
				<input style="display: none;" type="text" name="TxtIdSubCat" value="<?php Echo($Qr_IdSubCat)?>">
										</td>
										<td class="center">
				<input type="text" class="input-large" name="TxtNomSubCat" value="<?php echo utf8_encode($Qr_NombreSubCat); ?>">	
											</td>
											...
											<?php 
											if ($Qr_SubCat_Publicada==1) {
												?>
									<a class="green" href="Productos-Categoria.php?ValPublic=0&PublicSubCat=<?php Echo($Qr_IdSubCat)?>"  href=""><i class="fa fa-check"></i></a>
												<?php
											}
											else
											{
									...
									<a class="red" href="Productos-Categoria.php?ValPublic=1&PublicSubCat=<?php Echo($Qr_IdSubCat)?>"  href=""><i class="fa fa-close"></i></a>
												<?php
											}
											 ?>
...
?>
							...
							<div class="col-sm-6 col-xs-12">
								<a  data-toggle="modal" data-target="#myModalTallas" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> Nueva Talla </i></span></a>
											<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
						...
						<table  id="dynamic-table3"  class="table table-responsive table-striped table-bordered " width="100%">
											<thead>
												<tr class="blue">
													...
													<th class="" style="width: 5%">Talla</th>
												</tr>
											</thead>
											<tbody>

										<?php 
$sql ="SELECT Id_Talla,Nom_Talla From t_tallas";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Qr_IdTalla=$row['Id_Talla'];
        $Qr_NomTalla=$row['Nom_Talla'];
...
?>
												...
												<div class="col-sm-6 col-xs-12">
								<a  data-toggle="modal" data-target="#myModalColores" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> Nuevo Color </i></span></a>
											<div class="clearfix">
											<div class="pull-left tableTools-container"></div>
						...
						<table  id="dynamic-table3"  class="table table-responsive table-striped table-bordered " width="100%">
											<thead>
												<tr class="blue">
													<th class="center" style="width: 5%">Id</th>
													<th class="" style="width: 5%">Color</th>
												</tr>
											</thead>
											<tbody>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Qr_IdColor=$row['Id_Color'];
        $Qr_NomColor=$row['Nom_Color'];
         ...
         ?>
				...
				<?php Echo($Qr_IdColor); ?>	
										...
										<td class="center">
				<?php Echo utf8_encode($Qr_NomColor); ?>	
											</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nueva Línea de Producto</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <form class="form-horizontal" action="Productos-CrearLinea.php" id="FormNuevalinea" method="post" enctype="multipart/form-data">

         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Código</label>
					<div class="col-sm-9">
						<input required="true" autocomplete="off" type="text" id="ValNuevaLinea" name="txtDescArea" class="col-xs-10 col-sm-5" value="" style="text-transform:uppercase;" /><small>El código debe contener 3 Carácteres</small>
						<div id="MsjError"></div>
					</div>
         	...
         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre</label>
					<div class="col-sm-9">
						<input required="true" autocomplete="off" type="text" id="ValNomLinea" name="txtNombreArea" class="col-xs-10 col-sm-5" value="" style="text-transform:uppercase;" />
...
<div class="modal fade" id="myModalCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form class="form-horizontal" action="Productos-CrearSubcategoria.php" id="FormNuevaCategoria" method="post" enctype="multipart/form-data">

         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Código</label>
					<div class="col-sm-9">
						<input required="true" type="text" autocomplete="off" id="ValNuevaCategoria" name="txtDescArea" class="col-xs-10 col-sm-5" value="" style="text-transform:uppercase;" /><small>El código debe contener 2 Carácteres</small>
         	...
         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre</label>
					<div class="col-sm-9">
						<input required="true" type="text" autocomplete="off" id="ValNomCategoria" name="txtNombreArea" class="col-xs-10 col-sm-5" value="" style="text-transform:uppercase;" />
...
<!-- FIN MODAL -->
<!-- Modal -->
<div class="modal fade" id="myModalTallas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         <form class="form-horizontal" action="Productos-CrearTalla.php" id="FormNuevaTalla" method="post" enctype="multipart/form-data">
         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre Talla</label>
					<div class="col-sm-9">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-success">Crear Talla</button>
      </div>
      </form>
    </div>
  </div>
...
<!-- FIN MODAL -->
<!-- Modal -->
<div class="modal fade" id="myModalColores" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         <form class="form-horizontal" action="Productos-CrearColor.php" id="FormNuevoColor" method="post" enctype="multipart/form-data">
         	<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre Color</label>
					<div class="col-sm-9">
						<input required="true" type="text" id="form-field-1" name="txtNombreArea" class="col-xs-10 col-sm-5" value="" />
					</div>
			</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-success">Crear Color</button>
      </div>
      </form>
    </div>
  </div>
        ...
        $(document).ready(function()
        {
             $("#FormNuevalinea").validate({
             	errorElement: 'div',
					...
					ignore: "",
                 rules: {
                     "txtDescArea": { required:true,maxlength: 3,minlength: 3 },
                     "TxtNomLinea": { required:true }, 
        ...
        $(document).ready(function()
        {
             $("#FormNuevaCategoria").validate({
             	errorElement: 'div',
					...
					ignore: "",
                 rules: {
                     "txtDescArea": { required:true,maxlength: 2,minlength: 2 },
