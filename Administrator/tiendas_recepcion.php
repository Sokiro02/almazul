...
background: #8e24aa;
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==60) {
        echo "<script>jQuery(function(){swal(\"¡Error, no hay datos para procesar!\", \"Datos Incorrectos\", \"error\");});</script>";
    };
    if ($Valide==61) {
        echo "<script>jQuery(function(){swal(\"¡Error, No se puedo guardar la información!\", \"Contacte con el administrador\", \"error\");});</script>";
    };

    if ($Valide==63) {
        echo "<script>jQuery(function(){swal(\"¡La información fue guardada correctamente!\", \"Datos Guardado\", \"success\");});</script>";
    };
...
<div class="row">
       <?php 
       	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad and Id_Tienda='".$MyIdTienda."'";
              ...
              <div class="row">
                <div class="col-sm-12 center">
                  <div class="description-block">
                    <h5 class="description-header">INVENTARIO</h5>
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                 	...
                 	<a href="listado_recepcion.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
              </div>
