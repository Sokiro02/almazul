...
?>
			...
			<div class="main-content">
              ...
              <div class="center">
<form method="post" action="codigos_barra_taller.php" id="FormOrden">
    <input  type="text" name="MyIdTaller" value="<?php Echo($MyIdTaller) ?>">
    <input style="display: none;" type="text" name="ID_TIENDA" value="<?php Echo($id_tienda) ?>">
    <input style="display: none;" type="text" name="TOTAL" value="1">
    <div class="form-group">
      <div>
            <button type="submit" name="submit" class="btn btn-lg btn-success"><i class="fa fa-save"></i> IMPRIMIR DETALLE PRODUCCIÓN </button>
      </div>
    </div>
</form>
</div>  
...
if ($MyIdTaller=="") {
  $sql ="SELECT Id_Temporal_Sol FROM t_temporal_sol Where Estado_Solicitud_Cliente='1' and Bodega_Id_Bodega='".$MyIdTaller."' order by Id_Temporal_Sol  DESC";
  $result = $conexion->query($sql);
