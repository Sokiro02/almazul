					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Misventas.php">Detalle Ventas</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<div class="widget-body">
		<h4 class="widget-title lighter">
			...
			<div class="row">
				<form action="Misventas.php?QueryCon=<?php Echo($TxtConsultaVen) ?>" method="post" id="FormFechas" autocomplete="off">
...
if ($TxtConsultaVen=="") {
	$sql ="SELECT DISTINCT(Id_Venta) FROM t_ventas WHERE Fecha_Solicitud >='".$FechaStart."' and Fecha_Solicitud <='".$FechaEnd."' order by Id_Venta  DESC";
//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
...
{
	$sql ="SELECT DISTINCT(Id_Venta) FROM t_ventas WHERE Tienda_Id_Tienda='".$MyIdTienda."' and Fecha_Solicitud >='".$FechaStart."' and Fecha_Solicitud <='".$FechaEnd."' order by Id_Venta  DESC";
//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
...
if ($TxtConsultaVen=='') {
$sql ="SELECT Vendedor_Id_Usuario,Valor_Prenda,Valor_Final,Ref_Vendida,Factura_Id_Factura,Cant_Solicitada,Cliente_Id_Cliente,Referencia_Id_Referencia,Tienda_Id_Tienda From t_ventas  WHERE Id_Venta='".$Cadena[$i]."' and Factura_Id_Factura<>0"; 
//Echo($sql);
$result = $conexion->query($sql);
}
else
{
	$sql ="SELECT Vendedor_Id_Usuario,Valor_Prenda,Valor_Final,Ref_Vendida,Factura_Id_Factura,Cant_Solicitada,Cliente_Id_Cliente,Referencia_Id_Referencia,Tienda_Id_Tienda From t_ventas  WHERE Id_Venta='".$Cadena[$i]."' and Tienda_Id_Tienda='".$TxtConsultaVen."' and Factura_Id_Factura<>0"; 
//Echo($sql);
$result = $conexion->query($sql);
}
...
$Fecha_Solicitud=ObtenerfechaFactura($Factura_Id_Factura);
