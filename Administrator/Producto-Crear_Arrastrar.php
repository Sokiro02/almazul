...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Crear Producto Modasof</title>
    ...
    <!--/Fin Alertas-->
    <script type='text/javascript' src='http://christian.sietemedia.com.mx/filtros/jquery-1.7.1.min.js'></script>
...
?>
			...
			<div class="main-content">
				...
				<div class="col-xs-12"><!-- Inicio Panel 12 -->

<div class="col-sm-12">
	<!-- <div class="center">
		<h3>Diligenciar todos los campos seleccionados en rojo</h3>
	</div> -->
  ...
  <div  >
     <input type="text" class="busca nav-search-input input-xlarge"   id="caja_busqueda nav-search-input" name="clave" placeholder="Buscar Insumo por palabra clave"/>
     <br />
  </div>       
</form>
	...
	<div class="col-sm-9 center">
		<h3>Nueva Referencia de Producto  Modasof</h3>
	</div>
	
</div>
<div class="col-xs-12 col-sm-3" style="height:180px;overflow:scroll;"><!-- Inicio módulo fotos de Insumos -->
        <div id="display" style="cursor:move;">
									
		</div>
        
</div> <!-- Final módulo fotos de Insumos -->	
<form action="test.php" method="POST" id="FormProducto">
<div class="col-sm-9 col-xs-12">
	<div style="clear:both"></div>  
                ...
                <div class="col-sm-9" align="center">  
                     <div class="product_drag_area">Busque y arrastre el Insumo Aquí</div>  
                </div>
                 <div class="form-group col-sm-3">
										<!-- <label for="form-field-select-3"><h3>Imagen Producto</h3></label> -->
										<div class="col-sm-12">
 ...
 <div class="col-sm-12" id="dragable_product_order">  
   </div> 
   <h5><i class="fa fa-check"></i> Clasificación del Producto REF: 
 <span id="Cat" class="blue"></span><span id="SubCat" class="blue"></span><span id="TelaSel" class="blue"></span><span class="blue">1001</span>
 ...
 <div class="form-group col-sm-3">
                              ...
                              <div>
                        <select class="chosen-select input-xxlarge" id="TxtCategoria" name="TxtCategoria" data-placeholder="Seleccionar...">
...
?>  
  ...
  <div class="form-group col-sm-3">
                              ...
                              <div>
                        <select class="chosen-select input-xxlarge" id="TxtSubCategoria" name="TxtSubCategoria" data-placeholder="Seleccionar...">
                            <option value="">Seleccionar...</option>
                        <?php
...
?>  
   ...
   <div class="form-group col-sm-3">
                              <label for="form-field-select-3">Insumo Tela Principal</label>

                              <div>
                <select class="chosen-select input-xxlarge" id="TxtInsumo1" name="TxtInsumo1" data-placeholder="Seleccionar...">
                            <option value="">Seleccionar...</option>
                              <?php
$sql ="SELECT Id_Insumo, Cod_Insumo, Nom_Insumo FROM t_insumos WHERE Categoria_Id_Categoria_Insumo ='1' order by Cod_Insumo ASC";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
      $SelectId_Insumo=$row['Id_Insumo'];
      $SelectCod_Insumo=$row['Cod_Insumo']; 
      $SelectNom_Insumo=$row['Nom_Insumo'];  

      echo ("<option value='".$SelectId_Insumo."'>".utf8_encode($SelectCod_Insumo." - ".$SelectNom_Insumo)."</option>");
 }
}
