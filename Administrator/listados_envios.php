...
$Datos="Ingreso a Envios en Camino";
                    ...
                    <div class="row">
                        <table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                    	   <thead>
                    		...
                    		<tbody>
                            <?php 
                            $sql ="SELECT * FROM t_temporal_inventario_despachos WHERE status_despacho='DESPACHADO' order by id_despacho desc";  
                                ...
                                <tr>
                                    ...
                                    <td>
                						<div class=" action-buttons">
                							<a href="envios.php?Despacho=<?php echo($id_despacho);?>" class="tooltip-error green" data-rel="tooltip" data-placement="top" title="Recibir Despacho">
