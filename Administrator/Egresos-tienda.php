...
<body class="skin-1">
	...
	$Valide=$_GET['Mensaje'];
	if ($Valide==1) {
		echo "<script>jQuery(function(){swal(\"¡ Egreso Registrado!\", \"Correctamente \", \"success\");});</script>";
	};
	if ($Valide==2) {
		echo "<script>jQuery(function(){swal(\"¡ Egreso Registrado!\", \"Correctamente \", \"success\");});</script>";
	};
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active"><a href="Egresos-Tienda.php"><i class="fa fa-dollar"> </i> Egresos</a></li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<!-- 	<div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" id="FormGastos" method="post" action="GuardarEgreso-Tienda.php" enctype="multipart/form-data">
									
									<input style="display: none;" type="text" name="ProyectoGasto" value="<?php Echo($ProyectoSel) ;?>">
										...
										<div class="col-xs-12 col-sm-5">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Relación de Egresos</h4>
												...
												<div class="widget-body">
													<div class="widget-main">
														<div>
															<label for="form-field-select-3">Seleccionar Cuenta</label>

															<br />
															<select class="chosen-select form-control"  name="CuentaRecibe" data-placeholder="Seleccionar Rubro...">
																<option value="">Seleccionar</option>
																<option value="2015">Alex Baute</option>
																<option value="2016">Amalia Geles</option>
																<option value="2017">Ines Mazo</option>
																<option value="2020">Rodrigo Arregoces</option>
																<option value="2018">Taller Valledupar</option>
																<option value="2019">Taller Barranquilla</option>
															</select>
														</div>
														
														<hr />
														<div>
															<label for="form-field-select-3">A través de</label>

															<br />
															<select class="chosen-select form-control"  name="TxtMedio" data-placeholder="Seleccionar Rubro...">
																<option value="">Seleccionar</option>
								...
								<!-- <label ">Soporte</label>
														...
														<hr>
													-->
													<label for="id-date-picker-1">Fecha del Egreso</label>
...
$sql ="SELECT Valor_Transferido FROM t_mov_cuentas WHERE Id_Cuenta_Sale='".$MyIdTienda."' and Fecha_Transf >='".$FechaStart."' and Fecha_Transf <='".$FechaEnd."' order by Id_Mov_Cuenta  DESC";
	//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) { 
		$Lista=$row['Valor_Transferido']+$Lista;                  
	}
}
?>
...
<div class="col-xs-12 col-sm-6">
	<div class="widget-box">
		<div class="widget-header">
			<h4 class="widget-title">Total Egresos:<?php Echo(formatomoneda($Lista)); ?> // <?php echo ($MarcaTemporal);  ?></h4>
			...
			<div class="box box-widget widget-user-2">
				...
				<div class="box-footer no-padding">
					<ul class="nav nav-stacked">
						...
						$sql="SELECT Valor_Transferido,Marca_Temporal,Id_Mov_Cuenta,Detalle,Fecha_Transf FROM t_mov_cuentas WHERE Id_Cuenta_Sale='".$MyIdTienda."' and Fecha_Transf >='".$FechaStart."' and Fecha_Transf <='".$FechaEnd."' order by Id_Mov_Cuenta  DESC";
//Echo($sql);
						$result = $conexion->query($sql);
						if ($result->num_rows > 0) {
							while ($row = $result->fetch_assoc()) {                
								$Valor_Transferido=$row['Valor_Transferido'];
								$Reportado=$row['Marca_Temporal'];
								$Fecha_Transf=$row['Fecha_Transf'];
								$Id_Mov_Cuenta=$row['Id_Mov_Cuenta'];
								$Detalle=$row['Detalle'];
								
								?>	
								<li><a href="#">
									<strong><?php Echo utf8_encode($Id_Mov_Cuenta); ?>-Reportado el: <?php echo($Reportado); ?></strong><br>
									<strong>Concepto de la salida: </strong> <?php echo($Detalle) ?>
									<br>
									<strong>Fecha gasto: </strong> <?php echo($Fecha_Transf);?>
									<span class="pull-right badge bg-blue"><?php Echo formatomoneda($Valor_Transferido); ?></span></a></li>
						...
						<a class="btn btn-success" href="Informe-EgresosTienda.php">Ver todos los Egresos</a>
					</div>
				</div>
				<!-- /.widget-user -->
			</div>
