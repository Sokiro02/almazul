...
<h4 class="card-title">Seleccionar Bono</h4> 
                                <select required="true" class="chosen-select input-xxlarge" name="TxtBono" id="TxtClientes" data-placeholder="Seleccionar...">
...
<div class="col-sm-4 col-xs-12"><!-- Inicio Botonería -->
	<a href="CrearVenta.php" style="color:white;">
       ...
       <a href="CrearPlanSepare.php" style="color: white;">
        <div class="col-lg-12 col-xs-12">
          <!-- small box -->
