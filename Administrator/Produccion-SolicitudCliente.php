...
$RefSel=$_GET['RefSel'];
 ...
 $sql="SELECT pedidos_activos FROM t_config_tienda WHERE Tienda_Id_Tienda='".$MyIdTienda."'";
...
if ($pedidos_activos=="No") {
  header("location:Producto-Disponibilidad.php?Mensaje=22&RefSel=".$RefSel."");
}
...
contador++;
alert('Datos guardados!! Ingresar Datos de Cliente');
return true;
}
</script>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="Lista-Referencias.php">Galeria Referencias</a>
							</li>
						</ul><!-- /.breadcrumb -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-6">
                                        ...
                                        <h4 class="box-title m-t-40">Agregar a Pedido de Cliente 
                                        </h4>
...
?>
      ...
      <form action="Produccion-GuardarSolicitudCliente.php" method="post" id="FormSolicitud" onsubmit="return mifuncion();" >
<?php 
    ...
    $ClienteDoc=$_GET['ClienteDoc'];
     ?>
            ...
            <input style="display: none;" type="text" name="TxtRef" value="<?php Echo($RefSel);?>">
             ...
             <input style="display: none;" type="text" name="TxtBodega" value="5">
          ...
          <option value="1">1 Und. a Lista de Espera</option>
               ...
               ?>
                                  ...
                                  <select class="col-lg-2 col-xs-12" name="TxtTalla" required="true">
                                    ...
                                    <?php 
$sql ="SELECT Id_Talla, Nom_Talla FROM t_tallas WHERE talla_publicada='1' order by Nom_Talla ASC";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    ...
    if ($MyIdTienda!="") {
      ?>
       <select class="col-lg-3 col-xs-12" name="TxtAlmacen" required="true">
                                    ...
                                    <option value="<?php Echo($MyIdTienda);?>"><?php Echo($MiTienda); ?></option>
        </select>
   <?php                                 
    }
    else{
...
if ($result->num_rows > 0) {
  ...
  ?>
            ...
            <hr>
                  ...
                  <textarea placeholder="Indicar las necesidades especiales del Cliente" required="true" class="autosize-transition form-control" name="TxtDetalle" id="form-field-9" rows="5" maxlength="2000"><?php echo utf8_encode($Detalle_Referencia); ?>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
                   ...
                   <button style="margin:15px;" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-plus-square"></i> Solicitar a Producción</button>
        ...
        $(document).ready(function()
        {
             $("#FormSolicitud").validate({
                 ...
                 rules: {
                     ...
                     "TxtCantidadEspera": { required:true }, 
