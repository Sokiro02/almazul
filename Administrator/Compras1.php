			...
			<div class="main-content">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Compras.php">Compra Insumos</a>
							</li>
						</ul><!-- /.breadcrumb -->
				...
				?>
						...
						<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">A Crédito </h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-rosa"> <strong>$4.500.000</strong></div>
													</div>
												</div>
											</div>
										</div>
					...
					<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Pago Imediato </h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-verdeligth"><strong>$4.000.000</strong></div>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Total Mes</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-amarillo"> <strong>$9.500.000</strong></div>
													</div>
												</div>
											</div>
										</div>
						<div class="col-xs-12 col-sm-3 widget-container-col" id="widget-container-col-5">
											<div class="widget-box" id="widget-box-5">
												<div class="widget-header">
													<h5 class="widget-title smaller">Total Mes Anterior</h5>
												...
												<div class="widget-body">
													<div class="widget-main padding-6">
														<div class="alert degrade-amarillo"> <strong>$12.500.000</strong></div>
													</div>
												</div>
											</div>
										</div>
					...
					<?php 
$sql ="SELECT DISTINCT(Cod_Orden_Prov) FROM t_orden_compra_insumos";  
...
// Consulta Cantidad Solicitada
	$sql ="SELECT SUM(Cant_Mov) as TotalRecibido FROM t_mov_insumos WHERE OrdenCompra='".$CadenaCompras[$i]."' and Tipo_Mov_Insumo='Ingreso por Compra'"; 
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
