...
if (empty($id_tienda)){
    header("location:DespachosM2.php?TxtTienda=".$id_tienda."&Mensaje=66&TxtNomTienda=".$NomTienda);
}
...
if ($resultado){
    ...
    header("location:DespachosM2.php?TxtTienda=".$id_tienda."&Mensaje=65&TxtNomTienda=".$NomTienda);
}else{
    header("location:DespachosM2.php?TxtTienda=".$id_tienda."&Mensaje=66&TxtNomTienda=".$NomTienda);
}
?>