...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Informe Remisiones Tienda Modasof</title>
                              ...
                              else
                              {
                              	...
                              	<?php
                                  	 ...
                                  	 <a class="btn btn-success" href=""><i class="fa fa-dollar bigger-110"> </i> Crear Abono</a>
                                  	 	...
                                  	 	<td colspan="3">
                                  	 <a class="btn btn-danger" href="Informe-RemisionesTienda.php"><i class="fa fa-times bigger-110"> </i> Cerrar Vista</a>
                                  	 	</td>
                                  	 </tr>
                                  </tbody>
                         </table>
...
<div class="widget-body">
		<h4 class="widget-title lighter">
			...
			<div class="row">
				<form action="Informe-RemisionesTienda.php?QueryCon=<?php Echo($TxtConsultaVen) ?>" method="post" id="FormFechas" autocomplete="off">
...
if ($MyIdTienda=="") {
	$sql ="SELECT Id_Venta FROM t_salidas_remisiones WHERE Fecha_Solicitud >='".$FechaStart."' and Fecha_Solicitud <='".$FechaEnd."' order by Factura_Id_Factura  DESC";
}else{
	$sql ="SELECT Id_Venta FROM t_salidas_remisiones WHERE Fecha_Solicitud >='".$FechaStart."' and Fecha_Solicitud <='".$FechaEnd."' and Tienda_Id_Tienda='".$MyIdTienda."' order by Factura_Id_Factura  DESC";
}
                                    ...
                                    <th class="success"></th>
												...
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" >Observación</th>
...
?>
	...
	<td>
			...
			<a target="_blank" class=" btn btn-xs btn-danger" data-rel="tooltip" data-placement="top" title="Imprimir Remisión" href="Pdf_Remision.php?FacturaImp=<?php Echo($Num_Remision); ?>&mitienda=<?php echo($Tienda_Id_Tienda) ?>&cliente=<?php echo($Cliente_Id_Cliente) ?>"><i class="fa fa-file-pdf-o bigger-100 white"></i></a>	
	</td> 
