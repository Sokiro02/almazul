					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a class="blue" href="Centro-Distribucion.php?Stock=1">Inventario Talleres</a>
							</li>
						...
						<div class="clearfix">
							<hr>
										...
										<div class="table-header" style="background-color: #6FB3E0;">
											Inventario Referencias Genéricas
										</div>
...
$sql = "SELECT Cod_Solicitud_Prod FROM t_solicitudes_prod as A, t_referencias as B WHERE A.Estado_Solicitud_Prod='7' and A.Existencias_Ref>'0' and A.Bodega_Id_Bodega='".$tallerasociado."' and A.Referencia_Id_Referencia=B.Cod_Referencia and B.Ref_generica='1' order by A.Cod_Solicitud_Prod Desc ";
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
...
for ($i = 0; $i < $min; $i++) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $TotalStock = $pvp_Ref * $Cant_Solicitada;
    ...
    ?>
														...
														<tr>
					<td class="center">SLP<?php echo ($Cod_Solicitud_Prod); ?></td>
					<td class="tdcustom center"><?php echo ($CreadaFecha); ?></td>
                    <td>
					...
					<td class="tdcustom"><?php echo utf8_encode($Referencia_Id_Referencia); ?></td>
                    <td class="tdcustom"><?php echo utf8_encode($Nom_Talla); ?></td>
					<td class="tdcustom center"><?php echo ($Cant_Solicitada) ?></td>
