...
/* seleccionamos el tipo, estilo y tamaño de la letra a utilizar */
        ...
        $pdf->Cell(96,8,utf8_decode('COPIA RECIBO DE CAJA N°'.$Consecutivo),0,1,'C'); //Ancho, Alto, texto,borde,?,centrado
...
$pdf->AutoPrint();
        ...
        echo "<script language='javascript'>window.open('Clientes-Abonos.php?AbonosFactura=".$AbonosFactura."','_parent','');</script>";//para ver el archivo pdf generado
