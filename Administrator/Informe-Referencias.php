					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Informe-Referencias.php">Referencias Modasof</a>
							</li>
						</ul><!-- /.breadcrumb -->
											...
											<table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" >Vr. Insumos</th>
														<th class="tdcustom" >Vr. Mano de Obra</th>
														<th class="tdcustom" >Vr. Costo</th>
														<th class="tdcustom" >PVP</th>
														<th class="tdcustom" >Margen Bruto</th>
...
$sql ="SELECT SUM(Costo_Insumo_Ref*Cant_Solicitada) AS CostoInsumos FROM t_insumos_ref WHERE Referencia_Cod_Referencia='".$Cadena[$i]."' ";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    		while ($row = $result->fetch_assoc()) {                
...
$TotalCosto=$CostoInsumos+$V_Mano_Obra_Ref;

$Operacion1=((int)$TotalCosto/(int) $PVP_Ref);
...
$UtilidadBruta=$Operacion3;
				 ...
				 ?>
														...
														<tr>
															...
															<td class="tdcustom">
															<img width="60" height="60" src="../Administrator/<?php Echo utf8_encode($Img_Referencia) ?>">	
															</td>
															...
															<td class="tdcustom">
															<?php Echo utf8_encode(formatomoneda($CostoInsumos)) ?>	
															</td>
															<td class="tdcustom">
															<?php Echo utf8_encode(formatomoneda($V_Mano_Obra_Ref)) ?>	
															</td>
															<td class="tdcustom">
															<?php Echo utf8_encode(formatomoneda($TotalCosto)) ?>	
															</td>
															<td class="tdcustom">
													...
													<a href="Ficha_Tecnica2_Modasof.php?Ref=<?php Echo($Cod_Referencia); ?>" class="tooltip-primary blue" data-rel="tooltip" data-placement="top" title="Imprimir Ficha Técnica">
