...
$sql=("INSERT INTO t_referencias(Cod_Referencia, Img_Referencia, Fecha_Creacion,Coleccion_Id_Coleccion,Coleccion_Nom_Coleccion, Categoria_Id_Categoria_Prod, SubCategoria_Id_Subcategoria_Prod, Insumo_Ppal,Tipo_Tela,Color_Insumo_Ppal, Insumo_Sec, Estado_Ref, Costo_Proyectado_Pref, V_Mano_Obra_Ref, PVP_Ref, P_Mayor,Detalle_Referencia, Ref_Publicada,Tipo_Referencia,Ref_Antigua,Detalle_Antiguo) VALUES ('".$NuevaReferencia."','".$target."','".$TiempoActual."','".$TxtColeccion."','".$Nom_Coleccion."','".$TxtCategoria."','".$TxtSubCategoria."','".$Ref3."','".$TipoTelaIns."','".$ColorIns."','".$Ref4."','".$EstadoReferencia."','".$TxtTotalCosto."','".$TxtManodeObra."','".$PrecioVenta."','".$PrecioMayor."','".$TxtDetalle."','".$EstadoTek."','".$TipoReferencia."','".$TxtNomAnterior."','".$TxtDetalleAnterior."')");
	//Echo($sql);
	$result=$conexion->query($sql);
