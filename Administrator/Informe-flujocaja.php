					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Informe-flujocaja.php">Informe Ingresos</a>
							</li>
							<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-info">
														<li>
				<a  href="Informe-flujocaja.php">Ver todas las tiendas</a>
			</li>
														<?php
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    	...
    	?>
    		<li>
				<a  href="Informe-flujocaja.php?QueryCon=<?php Echo($SelectDown);?>&Mensaje=27"><?php Echo utf8_encode($NomDown); ?></a>
			</li>
    	<?php
 }
}
...
<div class="widget-body">
		<h4 class="widget-title lighter">
			...
			<div class="row">
				<form action="Informe-flujocaja.php?QueryCon=<?php Echo($TxtConsultaVen) ?>" method="post" id="FormFechas" autocomplete="off">
...
if ($TxtConsultaVen=="") {
	$sql ="SELECT Id_Tienda FROM t_tiendas WHERE Estado_Tienda='1' and Id_Tienda<>'7' order by Nom_Tienda Desc";
	//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
	$Lista=$Lista.$row['Id_Tienda'].",";                  
 }
}
}
...
{
	$sql ="SELECT Id_Tienda FROM t_tiendas WHERE Id_Tienda='".$TxtConsultaVen."'  and Id_Tienda<>'7' and Estado_Tienda='1' order by Nom_Tienda  DESC";
	//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
                                      ...
                                      <th class="success"></th>
												...
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" >Validación</th>
...
if ($TxtConsultaVen!="") {
	$sql ="SELECT Dia_Registro, B.Nom_Tienda FROM t_registro_caja as A, t_tiendas as B WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and A.Tienda_Id_Tienda=B.Id_Tienda and Fecha_Registro >='".$FechaStart."' and Fecha_Registro <='".$FechaEnd."' and Tienda_Id_Tienda='".$TxtConsultaVen."'";
		//Echo($sql);
		$result = $conexion->query($sql);
}
else  
{
	$sql ="SELECT Dia_Registro, B.Nom_Tienda FROM t_registro_caja as A, t_tiendas as B WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and A.Tienda_Id_Tienda=B.Id_Tienda and Fecha_Registro >='".$FechaStart."' and Fecha_Registro <='".$FechaEnd."'";
		//Echo($sql);
		$result = $conexion->query($sql);
}
...
// Valor de Apertura
$sql ="SELECT Valor_Confirmado FROM t_registro_caja as A, t_tiendas as B WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and A.Tienda_Id_Tienda=B.Id_Tienda and Tipo_Registro='1' and Fecha_Registro >='".$FechaStart."' and Fecha_Registro <='".$FechaEnd."'";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {  
...
// Valor de Cierre
$sql ="SELECT Valor_Confirmado FROM t_registro_caja as A, t_tiendas as B WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and A.Tienda_Id_Tienda=B.Id_Tienda and Tipo_Registro='2' and Fecha_Registro >='".$FechaStart."' and Fecha_Registro <='".$FechaEnd."'";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {  
...
// Valor de Efectivo
$sql ="SELECT IFNULL(sum(Valor_Ingreso),0) as IngresoEfectivo FROM t_ingresos as A WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and Fecha_Ingreso >='".$FechaStart."' and Fecha_Ingreso <='".$FechaEnd."' and Medio_Pago='1'";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {  
...
// Total Gastos
$sql ="SELECT IFNULL(sum(Valor_gasto),0) as TotalGastos FROM t_gastos as A WHERE Tienda_Id_Tienda='".$Cadena[$i]."' and Fecha_gasto >='".$FechaStart."' and Fecha_gasto <='".$FechaEnd."'";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {  
...
// Total Egresos
$sql ="SELECT IFNULL(sum(Valor_Transferido),0) as EgresosTienda FROM t_mov_cuentas as A WHERE Id_Cuenta_Sale='".$Cadena[$i]."' and Fecha_Transf >='".$FechaStart."' and Fecha_Transf <='".$FechaEnd."'";
		//Echo($sql);
		$result = $conexion->query($sql);
		if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {  
...
$TotalEntradas=$Valor_Apertura+$IngresoEfectivo;
$TotalSalidas=$TotalGastos+$EgresosTienda;
$ReporteSistema=$TotalEntradas-$TotalSalidas;

?>
														<tr>				
														<td class="center">
															<?php Echo($Dia_Registro) ?>
														</td>
														...
														<td class="center">
															<?php Echo utf8_encode("$ ".number_format($IngresoEfectivo));  ?>	
														</td>
														<td class="center">
