...
<!-- Fin de Primer Fila -->
				...
				<form method="post" action="DespachosM-guardar.php" id="FormOrden">
...
$consultas = "SELECT * FROM t_solicitudes_prod WHERE Estado_Solicitud_Prod ='".$valor_centro_distribucion."'and Existencias_Ref>0";
...
<br />
<div class="center">
    <a  href="DespachosM-Guardar2.php?IDTIENDA=<?php echo $Cod_Tienda;?>&NomTienda=<?php echo $Nom_Tienda2;?>">
