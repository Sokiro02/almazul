...
$Datos="Ingreso a Aceptar Traslados";
...
<!-- Small boxes (Stat box) -->
						...
						<div class="col-sm-12 col-xs-12"><!-- Panel 2  -->
						  ...
						  <h5 class="page-header">Seleccionar la Tienda que acepta el traslado</h5>
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    ...
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                 	...
                 	<a href="traslados_solicitudes.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
