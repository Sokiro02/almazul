...
<!-- Small boxes (Stat box) -->
      ...
      <div class="row">
       <?php 
       	 $sql="SELECT Id_Bodega,Nom_Bodega,Nom_Ciudad FROM t_bodegas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad";
              ...
              <div class="row">
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    ...
                    <span class="description-text">TALLER <?php Echo($Nom_Bodega); ?></span>
                  </div>
                 	...
                 	<a href="Pedidos.php?TxtTaller=<?php Echo($Id_Bodega); ?>&TxtNomTaller=<?php Echo($Nom_Bodega);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
