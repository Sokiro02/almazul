...
if ($MyIdTienda=="") {
	$sql ="SELECT distinct(Id_Pedido) FROM t_pedido WHERE Estado_Pedido<>'10' and Estado_Pedido<>'17' and Estado_Pedido<>'9' and Estado_Pedido<>'8' and Estado_Pedido<>'14' and taller_id_taller='".$MyIdTaller."'   order by Id_Pedido  DESC";
...
{
	$sql ="SELECT distinct(Id_Pedido) FROM t_pedido WHERE Tienda_Id_Tienda='".$MyIdTienda."' and Estado_Pedido<>'10'  and Estado_Pedido<>'9' and Estado_Pedido<>'17' and Estado_Pedido<>'8' and Estado_Pedido<>'14' and taller_id_taller='".$MyIdTaller."' order by Id_Pedido  DESC";
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
	$Lista=$Lista.$row['Id_Pedido'].",";                  
                                    ...
                                    <th class="success"></th>
												...
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" style="width: 5%;">Taller</th>
