...
header("location:Insumos-Productoterminado.php?Mensaje=18");
}
...
$result = $conexion->query($sql);
header("location:Insumos-Productoterminado.php?Mensaje=15&TAB=tabs-3");
}
...
function(isConfirm){
  if (isConfirm) {
    window.location.href = 'Insumos-Productoterminado.php?Confirmation=<?php Echo($DeleteInsumo); ?>';
  } else {
    window.location.href = 'Insumos-Productoterminado.php';
  }
});
// swal({
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Insumos-Productoterminado.php">Insumos</a>
							</li>
						</ul><!-- /.breadcrumb -->
									...
									<div class="modal-dialog">
										<div class="modal-content ">
											<div class="modal-header">
												<a href="Insumos-Productoterminado.php" type="button" class="close" data-dismiss="modal">&times;</a>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
										...
										<hr> 
											...
											<div class="modal-footer">
												<a href="Insumos-Productoterminado.php" class="btn btn-sm" data-dismiss="modal">
...
$sql ="SELECT Distinct(Cod_Insumo) FROM t_insumos WHERE Tipo_Insumo='2' order by Id_Insumo DESC";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
         ...
         if ($Tb_Tipo_Insumo==2) {
        	$Nom_Tipo_Insumo="PRODUCTO TERMINADO";
													 ...
													 ?>
                                                        ...
                                                        $mostrar_img = "miniatura.php?x=200&y=200&file=".$ruta_img;
														?>
									...
									<?php 
									 ...
									 ?>
											...
											if ($Valledupar==0 and $Barranquilla==0) {
											   ...
											   <a href="Insumos-Productoterminado.php?DeleteInsumo=<?php echo($Tb_Cod_Insumo);?>" class="tooltip-danger red" data-rel="tooltip" data-placement="top" title="Eliminar Insumo">
															<i class="fa fa-trash-o bigger-150"></i>
												</a>
												<?php
											}
											 ?>		
										<a href="Insumos-Productoterminado.php?EditTask=<?php echo($Tb_Id_Insumo);?>" class="tooltip-primary blue" data-rel="tooltip" data-placement="top" title="Editar Insumo">
...
<?php 
$sql ="SELECT Id_Mov_Insumos FROM t_mov_insumos as A, t_insumos as B WHERE A.Insumo_Cod_Insumo=B.Cod_Insumo and B.Tipo_Insumo='2' order by Id_Mov_Insumos DESC";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
