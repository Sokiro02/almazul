...
$sql ="SELECT * FROM t_facturas as A, t_clientes as B, t_usuarios as C WHERE num_consecutivo_sc='".$NumeroFactura."' and A.Cliente_Id_Cliente=B.Id_Cliente and A.Usuario_Vendedor=C.Id_Usuario and Tienda_Id_Tienda='".$DeTienda."'";
	//Echo($sql);
...
<h5><i class="fa fa-calendar"></i> Fecha Nota Entrega: <?php Echo (FechaSql($Fecha_Factura)) ?> </h5>
...
<div class="infobox infobox-green">
	...
	<div class="infobox-data">
		...
		<div class="infobox-content">Total Entrega</div>
	</div>
...
<?php 
	...
	$sql ="SELECT * FROM t_ventas as A, t_referencias as B WHERE consecutivosc_id_consecutivosc='".$Num_Factura."' and A.Referencia_Id_Referencia=B.Cod_Referencia and Tienda_Id_Tienda='".$DeTienda."'"; 
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
