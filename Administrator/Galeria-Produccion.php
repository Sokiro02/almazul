...
$Datos="Ingreso a Galeria de Produccion";
...
<html lang="en">
	<head>
		...
		<title>Galeria-Producción Modasof</title>
    ...
    <script src="https://modasof.com/espejo/assets/js/functions.js" async></script>
    <!-- Sweet Alert Script -->
...
url: "FiltroReferencias.php",//la url adonde se va a mandar la cadena a buscar
data: dataString,
//cache: false,
success: function(html){//funcion que se activa al recibir un dato
$("#Referencias").html(html).show();// funcion jquery que muestra el div con identificador display, como formato html, tambien puede ser .text
...
color:#FFF;
    ...
    <script type="text/javascript">
		...
		$("#BtnTendencias").on( "click", function() {
			$('#PanelTendencias').show(); //muestro mediante id
			$('#BtnOcultar').show(); //muestro mediante id
		 });
		$("#BtnOcultar").on( "click", function() {
			$('#PanelTendencias').hide(); //oculto mediante id
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==4) {
        echo "<script>jQuery(function(){swal(\"¡Referencia Modificada!\", \"Datos Correctos\", \"success\");});</script>";
    };
    if ($Valide==99) {
        echo "<script>jQuery(function(){swal(\"¡Lo Sentimos!\", \"No entro de la manera correcta a modificar referencia\", \"error\");});</script>";
    };
    if ($Valide==21) {
        echo "<script>jQuery(function(){swal(\"¡Lo Sentimos!\", \"Datos Incorrectos\", \"error\");});</script>";
    };
    if ($Valide==1) {
        echo "<script>jQuery(function(){swal(\"¡ Referencia Agregada!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==2) {
...
?>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Galeria-Produccion.php">Galeria Referencias</a>
							</li>
						</ul><!-- /.breadcrumb -->
  ...
  <div >
	...
	<div >
		<div>
	<a href="Lista-Referencias.php" class="btn btn-sm btn-white"><i class="fa fa-list"></i></a>
  	 <button id="BtnTendencias" class="btn btn-sm btn-white"><i class="fa fa-bar-chart"></i></button>
...
<div class="col-sm-12 col-xs-12"><!-- Inicio Panel Inferior-->
	 ...
	 <!-- Row -->
                <div class="row" id="PanelTendencias" style="display: none;">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php 
$sql ="SELECT Cod_SubCat_Producto FROM t_subcategoria_producto ";  
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
$Nom_Color=$row['Cod_SubCat_Producto'];

                                                 ?>

<button class="btn-xs" style="background-color: white;padding: 8px;border-width: 3px;color:black;font-size: 10px;cursor:none;"><b><?php Echo($Nom_Color) ?><br>34%</b></button>
<?php 
    }
} 
?>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php 
$sql ="SELECT Cod_Cat_Producto FROM t_categoria_producto ";  
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
$Nom_Color=$row['Cod_Cat_Producto'];
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php 
$sql ="SELECT Nom_SubCategoriaIns FROM t_subcategorias_insumos where Categoria_Id_Categoria_Insumo='1'";  
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
$Nom_Color=$row['Nom_SubCategoriaIns'];

                                                 ?>

<button class="btn-xs" style="background-color: white; padding: 8px;border-width: 3px;color:black;font-size: 10px;cursor:help;"><b><?php Echo utf8_encode($Nom_Color) ?><br>34%</b></button>
<?php 
    }
} 
?>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='https://modasof.com/espejo/assets/js/jquery.mobile.custom.min.js' async>"+"<"+"/script>");
		</script>
		<script src="https://modasof.com/espejo/assets/js/bootstrap.min.js" async></script>
		...
		<![endif]-->
		<script src="https://modasof.com/espejo/assets/js/jquery-ui.custom.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/jquery.ui.touch-punch.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/chosen.jquery.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/spinbox.min.js" async></script>
		...
		<script src="https://modasof.com/espejo/assets/js/moment.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/daterangepicker.min.js" async></script>
		...
		<script src="https://modasof.com/espejo/assets/js/jquery.dataTables.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/jquery.dataTables.bootstrap.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/dataTables.buttons.min.js" async></script>
		...
		<script src="https://modasof.com/espejo/assets/js/dataTables.select.min.js" async></script>
		...
		<script src="https://modasof.com/espejo/assets/js/jquery.validate.min.js" async></script>
		<script src="https://modasof.com/espejo/assets/js/jquery-additional-methods.min.js" async></script>

		<script src="https://cdn.datatables.net/responsive/1.0.7/js/dataTables.responsive.min.js" async></script>
		 <script type="text/javascript">
     /*   $(document).ready(function()
        {
