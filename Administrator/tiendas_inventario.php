...
<!-- Small boxes (Stat box) -->
      ...
      <div class="row">
    <?php 
    $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad and A.Estado_Tienda='1' ";
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    ...
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                 	...
                 	<a href="DespachosM.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
