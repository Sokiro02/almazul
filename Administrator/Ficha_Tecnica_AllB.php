...
$Datos="Creada la ficha tecnica de la referencia: ".$Referencia;
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        ...
        $pdf->Cell(260,2, utf8_decode(' Cr. 9 No. 7C-33 (Valledupar) Barrio Novalito Tels: 5838943 - 300-2886406 Email Modasofaute@hotmail.com '), 0, 'L');
		        ...
		        $pdf->Output("Facturas/Ficha-Tecnica-Modasof.pdf",'F');
		...
		echo "<script language='javascript'>window.open('Facturas/Ficha-Tecnica-Modasof.pdf','_blank','');</script>";

		echo "<script language='javascript'>window.open('Lista-Referencias.php','_parent','');</script>";//para ver el archivo pdf generado
