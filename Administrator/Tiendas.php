...
?>
		...
		$sql ="SELECT Nom_Ciudad,Id_Tienda, Cod_Tienda, Nom_Tienda,  Dir_Tienda, Tel_Tienda,Cel_Tienda,  Ciudad_Id_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad  and Id_Tienda='".$EditTask."'"; 
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Qr_Id_Tienda=$row['Id_Tienda'];
        $Qr_Cod_Tienda=$row['Cod_Tienda'];
        $Qr_Nom_Tienda=$row['Nom_Tienda'];
        $Qr_Dir_Tienda=$row['Dir_Tienda'];
        $Qr_Tel_Tienda=$row['Tel_Tienda'];
        $Qr_Cel_Tienda=$row['Cel_Tienda'];
        $Qr_Nom_Ciudad=$row['Nom_Ciudad'];
					...
					<form action="Tienda-ActualizarTienda.php" method="post" id="FormUpdateBodega">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												
												<h4 class="blue bigger">Editar Tienda</h4>
											</div>
										...
										<div class="col-xs-12 col-sm-6 ">
														...
														<div class="form-group">
															<label for="form-field-select-3">Nombre Tienda</label>

															<div class="input-group">
																<span class="input-group-addon">
																	<i class="ace-icon fa fa-user"></i>
																</span>
												<input type="text" name="UpTxtNombre" class="input-large" placeholder="Nombre Tienda" style="text-transform:uppercase;" value="<?php Echo utf8_encode($Qr_Nom_Tienda) ?>">
							<input style="display: none;" type="text" name="TxtEditProv" value="<?php Echo utf8_encode($EditTask) ?>">
														...
														<div class="form-group">
															<label for="form-field-select-3">Cód Tienda</label>

															<div class="input-group">
																<span class="input-group-addon">
																	<i class="ace-icon fa fa-bank"></i>
																</span>
												<input type="text" name="UpTxtCod" class="input-large" placeholder="Código Tienda" style="text-transform:uppercase;" value="<?php Echo utf8_encode($Qr_Cod_Tienda) ?>">
															</div>
							...
							<input type="text" name="UpTxtDir" class="input-large" placeholder="Dirección de Tienda" style="text-transform:uppercase;" value="<?php Echo utf8_encode($Qr_Dir_Tienda) ?>">
															</div>
								...
								<input name="UpTxtCelular" class="form-control input-mask-phone" type="text" id="form-field-mask-2" value="<?php Echo utf8_encode($Qr_Cel_Tienda) ?>" />
															</div>
								...
								<input name="UpTxtTel" class="form-control input-mask-phone" type="text" id="form-field-mask-2" value="<?php Echo utf8_encode($Qr_Tel_Tienda) ?>" />
															</div>
												...
												<a href="Tiendas.php" class="btn btn-sm" data-dismiss="modal">
					...
					<?php 
					 ...
					 ?>
						...
						<div class="col-sm-12 col-xs-12">
							<a  data-toggle="modal" data-target="#modal-form" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> </i> Nueva Tienda</span></a>
						<!-- Inicio Modal -->
								<div id="modal-form" class="modal" tabindex="-1">
							<form action="Tienda-CrearTienda.php" method="post" id="FormNuevaBodega">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal">&times;</button>
												<h4 class="blue bigger">Nueva Tienda</h4>
											</div>
											...
											<div class="modal-body">
												...
												<input type="text" name="TxtNombre" class="input-large" placeholder="Nombre Tienda" style="text-transform:uppercase;">
															</div>
														
														</div>
														
														<div class="form-group">
															<label for="form-field-select-3">Código Tienda</label>

															<div class="input-group">
																<span class="input-group-addon">
																	<i class="ace-icon fa fa-bank"></i>
																</span>
												<input type="text" name="TxtCod" class="input-large" placeholder="Código Tienda" style="text-transform:uppercase;">
															</div>
...
?>
							...
							<input type="text" name="TxtDir" class="input-large" placeholder="Dirección de Tienda" style="text-transform:uppercase;">
															</div>
											...
											<table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover">
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" style="width: 20%;">Tienda</th>
												...
												<tbody>
<?php 
$sql ="SELECT Cod_Tienda,Tel_Tienda,Nom_Ciudad,Id_Tienda, Nom_Tienda,Dir_Tienda, Cel_Tienda,  Ciudad_Id_Ciudad FROM t_tiendas as A, t_ciudades as B  WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad "; 
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        $Tb_Id_Tienda=$row['Id_Tienda'];
        $Tb_Cod_Tienda=$row['Cod_Tienda'];
        $Tb_Nom_Tienda=$row['Nom_Tienda'];
        $Tb_Dir_Tienda=$row['Dir_Tienda'];
        $Tb_Cel_Tienda=$row['Cel_Tienda'];
        $Tb_Tel_Tienda=$row['Tel_Tienda'];
        $Tb_Nom_Ciudad=$row['Nom_Ciudad'];
													 ?>
														...
														<a href="Tiendas.php?EditTask=<?php echo($Tb_Id_Tienda);?>" class="tooltip-primary blue" data-rel="tooltip" data-placement="top" title="Editar Bodega">
																	<?php echo utf8_encode("T".$Tb_Cod_Tienda); ?>
														</a>
														</td>
														<td class="tdcustom" style="text-transform:uppercase;">
															<?php Echo utf8_decode($Tb_Nom_Tienda) ?>
																
															</td>
														
														<td class="tdcustom" style="text-transform:uppercase;"><?php echo utf8_encode($Tb_Dir_Tienda."- (".$Tb_Nom_Ciudad).")"; ?></td>
														
														
														<td class="tdcustom" style="text-transform:uppercase;">
									
									<?php 
									$CadenaCel="<i class='fa fa-mobile-phone'> </i> ".$Tb_Cel_Tienda;
									$CadenaWhp="<i class='fa fa-phone'> </i> ".$Tb_Tel_Tienda;
...
echo nl2br($cadena);
									 ?>
														...
														<td class="center">
																...
																<a href="tienda-configurar.php?tiendasel=<?php echo($Tb_Id_Tienda) ?>" class="tooltip-danger red" data-rel="tooltip" data-placement="top" title="Configurar Tienda">
																	<i class="ace-icon fa fa-gears bigger-120"> </i> Configurar Tienda
																</a>
														</td>
													</tr>
													<?php 
