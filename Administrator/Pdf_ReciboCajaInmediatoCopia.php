...
$sql ="SELECT Id_Ingreso, Concepto_Ingreso, Medio_Pago,Num_Transaccion,Valor_Ingreso FROM t_ingresos WHERE Cod_Recibo_Caja='".$Cod_Recibo_Caja."' and Tienda_Id_Tienda='".$latienda."'";  
...
$pdf->AutoPrint();
                $pdf->Output("Facturas/ReciboCajaCopia.pdf",'I');




        echo "<script language='javascript'>window.open('Facturas/ReciboCajaCopia.pdf','_blank','');</script>";

        echo "<script language='javascript'>window.open('Informe-RecibosdeCaja.php','_parent','');</script>";//para ver el archivo pdf generado
