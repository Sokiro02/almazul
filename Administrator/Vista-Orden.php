					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Panel-Produccion.php">Ordenes</a>
							</li>
						</ul><!-- /.breadcrumb -->
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center class="m-t-30"> <img src="../Administrator/Images/Perfiles/5.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">Sastre Asignado</h4>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <button class="btn btn-circle btn-secondary"><i class="fa fa-phone"> (350) 709-3027</i></button>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Obsevaciones</a> </li>
												...
												<div class="timeline-items">
													<div class="timeline-item clearfix">
														<div class="timeline-info">
															<img alt="Susan't Avatar" src="../Administrator/Images/Perfiles/8868-WebMaster.jpg" />
