...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Solicitudes Modasof</title>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="SolicitudesProduccion.php">Solicitudes Producción</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<div class="col-sm-12"><!-- Inicio Panel 12 -->
										<div class="tabbable">
											...
											<div class="tab-content">
												<div id="tabs-1" class="tab-pane fade" ><!-- Inicio Tab Número Uno -->
													<div class="clearfix">
										...
										<div>
												...
												<div id="tabs-2" class="tab-pane fade in active"><!-- Inicio Tab Número Dos -->
		...
		<?php 
$sql ="SELECT Id_Solicitud_Prod FROM t_solicitudes_prod Where Bodega_Id_Bodega='".$MyIdTaller."' and  Estado_Solicitud_Prod<>'10' and Estado_Solicitud_Prod<>'9' and Estado_Solicitud_Prod<>'7' and Estado_Solicitud_Prod<>'8' and Estado_Solicitud_Prod<>'11' and Estado_Solicitud_Prod<>'12' and Estado_Solicitud_Prod<>'13' order by Id_Solicitud_Prod  DESC";
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
	$Lista2=$Lista2.$row['Id_Solicitud_Prod'].",";                  
 }
}
...
if ($result->num_rows > 0) {
    ...
    $ValidaEstado=$row['Estado_Solicitud_Prod'];
						...
						<a data-rel="tooltip" data-placement="top" title="Detalles Solicitud" href="Panel-Produccion.php?Solicitud=<?php Echo($Cod_Solicitud_Prod); ?>">
							...
							<a class="image-link" href="<?php echo utf8_encode($Img_Referencia); ?>"><img src="<?php echo utf8_encode($Img_Referencia); ?>" width="40px" height="40px"></a>
								...
								<?php Echo utf8_encode($Cant_Solicitada) ?>Un.
														...
														<td class="tdcustom">
															<?php 
                $sql ="SELECT `Id_Estado_Pedido`,Nom_Estado_Pedido, `Color_Estado`, `Desc_Estado`, `Rol_Id_Rol` FROM `t_estado_pedidos` WHERE Id_Estado_Pedido='".$Estado_Solicitud_Prod."'"; 
    //Echo($sql); 
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
