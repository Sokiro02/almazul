											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														<div>
															<label for="form-field-select-3">Seleccionar Área</label>

															<br />
															<select name="TxtSelArea" class="chosen-select form-control" id="form-field-select-2" data-placeholder="Seleccionar Área...">
																<option value="">Seleccionar</option>
																	<?php
$sql ="SELECT Id_Area, Nom_Area FROM t_areas";  
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    	$SelectIdArea=$row['Id_Area'];
    	$SelectNombreArea=$row['Nom_Area'];             
    	echo ("<option value='".$SelectIdArea."'>".utf8_encode($SelectNombreArea)."</option>");
 }
}
...
<div id="info">
					...
					<div class="col-xs-12 col-sm-6">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Gastos Hotel Arenas</h4>
												...
												<div class="widget-body col-sm-7">
													<div class="widget-main">
													<h3><?php Echo($Qr_Nombreproyecto) ?></h3>
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo formatomoneda(1000000); ?></span>
												<div class="infobox-content"><a href="TotalActivos.php">Gastos Administrativos </a></div>
											</div>
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo formatomoneda(SumaGastos($ProyectoSel)) ?></span>
												<div class="infobox-content"><a href="TotalActivos.php">Gastos a la Fecha </a>
												</div>
												
											</div>
											<div class="badge badge-danger">
												<?php Echo round($PorcentajeGastado,2); ?> %
										...
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><?php Echo formatomoneda($RecursosDisponibles) ?></span>
												<div class="infobox-content">Recursos Disponibles</div>
											</div>
										<?php if ($PorcentajeDisponible<=100): ?>
											<div class="badge badge-success">
												<?php Echo round($PorcentajeDisponible,2); ?> %
										...
										<?php endif ?>
												...
												<img width="190" height="180" alt="220x220" src="Images/Logos/LogoHotel.jpg" />
