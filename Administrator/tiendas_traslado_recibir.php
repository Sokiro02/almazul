...
$Datos="Ingreso a Recepcion de Traslados ";
...
<!-- Small boxes (Stat box) -->
						...
						<div class="col-sm-12 col-xs-12"><!-- Panel 2  -->
						  ...
						  <h5 class="page-header">Seleccionar La Tienda a Recibir el Traslado</h5>
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    ...
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                 	...
                 	<a href="traslados_recibir.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
