					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="detalle-despachos.php">Despachos</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<div class="col-sm-12"><!-- Inicio Panel 12 -->
										...
										<div class="table-header" style="background-color: #000;">
											Lista de Despachos <?php Echo($MiTienda); ?>
										</div>
...
$InformeDesde=("2018-10-01");

$FechaInicioDia=($InformeDesde." 00:00:000");
$FechaFinalDia=($MarcaTemporal." 23:59:000");


if ($MyIdTienda=="") {
$sql ="SELECT id FROM t_temporal_inventario WHERE fecha_ingreso >='".$FechaInicioDia."' and fecha_ingreso <='".$FechaFinalDia."'  ORDER BY id  DESC";
//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
...
{
	$sql ="SELECT id FROM t_temporal_inventario WHERE id_tienda='".$MyIdTienda."' and fecha_ingreso >='".$FechaInicioDia."' and fecha_ingreso <='".$FechaFinalDia."' order by id  DESC";
//Echo($sql);
	$result = $conexion->query($sql);
	if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { 
                                    ...
                                    <th class="success"></th>
												...
												<thead>
													...
													<tr class="warning">
														...
														<th class="tdcustom" style="width: 20%;">Referencia</th>
														<th class="tdcustom" style="width: 20%;">Cantidad</th>
