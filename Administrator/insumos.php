...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Categoria Insumos Modasof</title>
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="insumos.php">Categoria Insumos</a>
							</li>
							<li>
								<i class="ace-icon fa fa-list"></i>
								<a href="Lista-Insumos.php">Lista Insumos</a>
							</li>
						</ul><!-- /.breadcrumb -->
		...
		<form action="Insumo-ActualizarInsumo.php" method="post" id="FormActualizarInsumo" enctype="multipart/form-data">
								<input type="text" style="display: none;" name="TxtIdInsumo" value="<?php Echo($EditTask); ?>">
									...
									<div class="modal-dialog">
										<div class="modal-content ">
											<div class="modal-header">
												<a href="Lista-Insumos.php" type="button" class="close" data-dismiss="modal">&times;</a>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
	...
	<input style="display: none;" type="text" name="Qr_Cod_Insumo" name="Qr_Cod_Insumo" value="<?php Echo($Qr_Cod_Insumo)?>">
											...
											<div class="modal-footer">
												<a href="Lista-Insumos.php" class="btn btn-sm" data-dismiss="modal">
													<i class="ace-icon fa fa-times"></i>
													Cancelar
												</a>
										...
										<div class="tabbable">
											...
											<!-- 	<li id="Tab-Categoria-Insumos">
												...
												<i class="red ace-icon fa fa-gear bigger-120"></i>
													...
													<li style="display: none;" id="Tab-Categoria-Insumos">
...
<?php 
 ...
 ?>
							...
							<div style="display: none;" id="tabs-4" class="tab-pane fade"><!-- Inicio Tab Número Cuatro -->
