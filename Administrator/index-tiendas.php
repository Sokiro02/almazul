...
include("Lib/seguridad.php");
    $Datos="Ingreso a la pagina principal de tiendas";
...
<!-- Small boxes (Stat box) -->
						...
						<div class="col-sm-12 col-xs-12"><!-- Panel 2  -->
						  ...
						  <h5 class="page-header">Seleccionar Tienda</h5>

      <div class="row">
       <?php
       if ($IdUser=='49') {
        	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE Id_Tienda='3' and A.Ciudad_Id_Ciudad=B.Id_Ciudad";
        }
         elseif ($IdUser=='57') {
        	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE Id_Tienda='7' and A.Ciudad_Id_Ciudad=B.Id_Ciudad";
        }
         elseif ($IdUser=='65') {
        	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE Id_Tienda='3' and A.Ciudad_Id_Ciudad=B.Id_Ciudad";
        }
        elseif ($IdUser=='71') {
         ...
         elseif ($IdUser=='66') {
        	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE Id_Tienda='8' and A.Ciudad_Id_Ciudad=B.Id_Ciudad";
        }
        elseif ($IdUser=='97') {
        	 $sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE Id_Tienda='10' and A.Ciudad_Id_Ciudad=B.Id_Ciudad";
        }
        else
        {
        	$sql="SELECT Id_Tienda,Nom_Tienda,Dir_Tienda,Nom_Ciudad FROM t_tiendas as A, t_ciudades as B WHERE A.Ciudad_Id_Ciudad=B.Id_Ciudad and vista_tienda='0' order by Cod_tienda asc";
        }
              ...
              <div class="row">
                ...
                <div class="col-sm-12 center">
                  ...
                  <div class="description-block">
                    <h5 class="description-header">ADMINISTRAR</h5>
                    <span class="description-text">TIENDA <?php Echo($Nom_Tienda); ?></span>
                  </div>
                 
                 	<!-- <input style="display: none;" type="text" name="TxtTienda" value="<?php Echo($Id_Tienda);?>">
                 	<input style="display: none;" type="text" name="TxtNomTienda" value="<?php Echo($Nom_Tienda);?>"> -->

                 	<a href="index-ventas.php?TxtTienda=<?php Echo($Id_Tienda); ?>&TxtNomTienda=<?php Echo($Nom_Tienda);?>" class="btn btn-primary "><i class="fa fa-user"></i> Ingresar</a>
