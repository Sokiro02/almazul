...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Ingreso de dinero a tienda</title>
...
<!-- Fin Libreria formato moneda -->
  ...
  $Valide=$_GET['Mensaje'];
    if ($Valide==1) {
        echo "<script>jQuery(function(){swal(\"¡ Ingreso de dinero registrado!\", \"Correctamente \", \"success\");});</script>";
    };
...
include("Lib/menuleft.php");
 ?>
			...
			<div class="main-content">
				...
				<li class="active"><a href="ingresodinero-tienda.php"><i class="fa fa-dollar"> </i> Ingreso Dinero</a></li>
						</ul><!-- /.breadcrumb -->
					...
					<!-- 	<div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" id="FormGastos" method="post" action="Guardaringresodinero.php" enctype="multipart/form-data">
							...
							<input style="display: none;" type="text" name="ProyectoGasto" value="<?php Echo($ProyectoSel) ;?>">
										...
										<div class="col-xs-12 col-sm-5">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Relación de Ingreso de Dinero</h4>
								...
								<div>
									<label for="form-field-select-3">Seleccione la fuente del ingreso </label>

															<br />
															<select class="chosen-select form-control"  name="fuente" data-placeholder="">
																<option value="">Seleccionar</option>
																<option value="1">Amalia Geles</option>
																<option value="2">Alex Baute</option>
															</select>
														</div>

														<label for="id-date-picker-1">Fecha del ingreso</label>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
														...
														<div>
															<label for="form-field-9">Indique las observaciones del ingreso</label>
