		...
		<div class="page-content">
			...
			<!-- Inicio botones de acceso rápido -->
                ...
                <!-- Small boxes (Stat box) -->
                    ...
                    <h5 class="page-header">Seleccionar Despacho a cliente a consultar</h5>
                    <div class="row">
                        <table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                    	   <thead>
                    	       <tr class="warning">
                    					<th class="tdcustom" style="width: 8%;">Cliente</th>
                    					<th class="tdcustom" style="width: 4%;">Fecha Rec.</th>
                    					<th class="tdcustom" style="width: 4%;">Referencia</th>
                    					<th class="tdcustom" style="width: 10%;">Detalle Ref</th>
                    		...
                    		<tbody>
                            <?php 
                            $sql ="SELECT * FROM t_temporal_inventario WHERE id_tienda='".$IdTienda."' and status_recibido='RECIBIDO' and cliente = 'SI' ORDER BY fecha_ingreso DESC";  
                            $result = $conexion->query($sql) or die('Error:'.mysqli_error($conexion));;
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) { 
                                    $id_despacho=$row['id_despacho'];
                                    $fecha_despacho = $row['fecha_ingreso'];
                                    ...
                                    $referencia = $row['cod_ref'];
                                    $detalle_referencia = $row['detalle_ref'];
                                    $cant = $row['cantidad'];
                                    $valor_und =$row['valor_unidad'];
                                    $valor_total = $row['valor_total'];
                                    $nro_despacho = $row['id_despacho'];
                                    //DATOS DEL CLIENTE
                                ...
                                <tr>
                                    <td>
                                        <a href="despachos_detalle_clientes.php?cliente=<?php echo $id_cliente;?>"><?php echo $NombreCliente;?></a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo Formatomoneda($valor_und);?>
                                    </td>
                                    <td>
                                        <?php echo Formatomoneda($valor_total);?>
                                    </td>
                                    <td>
                                        <?php echo $nro_despacho;?>
                                    </td>
