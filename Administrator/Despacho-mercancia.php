...
$Datos="Ingreso a Despacho de Mercancia";
		...
		<script language='javascript'>
			$(function(){
				$('#envio').on('click', function (e){
					...
					incluÃ­a en los formularios (y que aÃºn se incluye, cuando son enviados 
					desde HTML. */
					var paqueteDeDatos = new FormData();
					/* Todos los campos deben ser aÃ±adidos al objeto FormData. Para ello 
					usamos el mÃ©todo append. Los argumentos son el nombre con el que se mandarÃ¡ el 
					dato al script que lo reciba, y el valor del dato.
					Presta especial atenciÃ³n a la forma en que agregamos el contenido 
					...
					$.ajax({
						url: destino,
						type: 'POST', // Siempre que se envÃ­en ficheros, por POST, no por GET.
						contentType: false,
						...
						error: function (){ // Si hay algÃºn error.
							alert("Algo ha fallado. Verifique que toda la informaci�n es correcta");
                            var var1 ="21";
...
url: "buscar_refererencia.php",//la url adonde se va a mandar la cadena a buscar
data: dataString,
//cache: false,
...
$(document).ready(function(){
  ...
  $Valide=$_GET['Mensaje'];
    ...
    if ($Valide==5) {
        echo "<script>jQuery(function(){swal(\"Â¡Lo Sentimos!\", \"Imagen demasiado grande\", \"error\");});</script>";
    };
    if ($Valide==21) {
        echo "<script>jQuery(function(){swal(\"Â¡Lo Sentimos!\", \"Datos Incorrectos\", \"error\");});</script>";
    };
     if ($Valide==111) {
        echo "<script>jQuery(function(){swal(\"Â¡Verifique el peso de la imagen!\", \"Ref. No Creada\", \"error\");});</script>";
    };
    if ($Valide==551) {
        echo "<script>jQuery(function(){swal(\"Â¡No selecciono Tipo de Producto!\", \"Ref. No Creada\", \"error\");});</script>";
    };
    if ($Valide==552) {
        echo "<script>jQuery(function(){swal(\"Â¡No Selecciono la Categoria!\", \"Ref. No Creada\", \"error\");});</script>";
    };
    if ($Valide==553) {
        echo "<script>jQuery(function(){swal(\"Â¡No selecciono Insumo Ppal!\", \"Ref. No Creada\", \"error\");});</script>";
    };
    if ($Valide==554) {
        echo "<script>jQuery(function(){swal(\"Â¡No Selecciono Insumo Ppal!\", \"Ref. No Creada\", \"error\");});</script>";
    };
    ...
    if ($Valide==1) {
        echo "<script>jQuery(function(){swal(\"Â¡ Insumo  Agregado!\", \"Correctamente \", \"success\");});</script>";
    };
     if ($Valide==2) {
        echo "<script>jQuery(function(){swal(\"Â¡ Insumo  Eliminado!\", \"Correctamente \", \"success\");});</script>";
    };
    if ($Valide==23) {
        echo "<script>jQuery(function(){swal(\"Â¡ Extra Cargada a Cliente!\", \"".$ClienteSel." \", \"success\");});</script>";
    };
   ?>
...
<form action="#" method="post" id="FormProducto" enctype="multipart/form-data" autocomplete="off">
		...
		<h3><i class="fa fa-search"></i> Busqueda de Referencias</h3>

     <input type="text" class="busca nav-search-input input-xxlarge"   id="caja_busqueda nav-search-input" name="clave" placeholder="Busque el insumo aqu�� y haga clic en Agregar"/>
     <br />
      

<div id="display"  class="col-sm-12 col-xs-12" style="height:400px;overflow:scroll;">
...
<div class="col-sm-12 col-xs-12">
 <h3>Detalle de Referencias</h3>  
                <div class="table-responsive">  
                     <table class="table table-bordered"> 
                     <thead> 
                          <tr class="info">  
                              <th width="10%">Img.</th>
                               <th width="25%">C�digo - Nombre Insumo </th>  
...
?>  
  ...
  <!-- Selects Listados con Ajax -->
   <div class="form-group col-sm-3 col-xs-12" id="SelectTelas"></div>
   <div class="form-group col-sm-3 col-xs-12" id="SelectTelas2"></div>
  <!-- Fin Selects  -->
  <div class="col-xs-12 col-sm-12">
...
<div class="form-group col-sm-3 col-xs-12">
              <label for="form-field-select-3">P.V.P</label>
                              <div>
                          <input class="input-xlarge" type="text" id="demo2" placeholder="Costo Proveedor 1" name="demo2"  required="true" />
                                </div>
                                <script type="text/javascript">     
$("#demo2").maskMoney({
...
<div class="form-group col-sm-3 col-xs-12">
              <label for="form-field-select-3">Precio al Mayor</label>
                              <div>
                          <input class="input-xlarge" type="text" id="demo3" placeholder="" name="demo3"  required="true" />
                                </div>
                                <script type="text/javascript">     
$("#demo3").maskMoney({
prefix:'$ ', // The symbol to be displayed before the value entered by the user
...
<div class="col-sm-12 col-xs-12">
	<h5> <i class="fa fa-cogs"></i> CaracterÃ­sticas</h5>
  <div class="form-group col-sm-3 col-xs-12">
                              <label for="form-field-select-3">Nombre ColecciÃ³n</label>
...
<div class="col-xs-12 col-sm-12">
	 <div class="form-group col-sm-6 col-xs-12">
                      <label for="form-field-9">CaracterÃ­sticas</label>
...
<![endif]-->
		...
		<script type="text/javascript">
           ...
           if(confirm("Â¿Seguro que quieres eliminar este insumo?"))  
           {  
                var id = $(this).attr("id");  
                //var action="delete";  
                $.ajax({  
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#id-input-file-3').ace_file_input({
					...
					if(info.error_count['size']) alert('TamaÃ±o de archivo invalido, Max 1.5MB');
