                    ...
                    <div class="row">
                        <table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                    	   <thead>
                    		...
                    		<tbody>
                            <?php 
                                $sql = "SELECT * FROM t_traslados WHERE id_tienda_hasta = '".$Tienda."' and status = 'ENVIADO'";
                                ...
                                <tr>
                                    ...
                                    <td>
                						<div class=" action-buttons">
                							<a href="traslados_solicitudes_de_re.php?Traslado=<?php echo($id);?>" class="tooltip-error green" data-rel="tooltip" data-placement="top" title="Recibir traslado">
