					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Informe-Cartera.php">Cartera</a>
							</li>
							<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-info">
														<li>
				<a  href="Informe-Cartera.php">Ver todas las tiendas</a>
			</li>
														<?php
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    	...
    	?>
    		<li>
				<a  href="Informe-Cartera.php?QueryCon=<?php Echo($SelectDown);?>&Mensaje=27"><?php Echo utf8_encode($NomDown); ?></a>
			</li>
    	<?php
 }
}
...
?>      
												...
												<a href="Informe-Cartera.php" class="btn btn-sm" data-dismiss="modal">
...
<a  data-toggle="modal" data-target="#modal-form" href="#"><span class="btn btn-danger pull-right"><i class="fa fa-plus-square"> </i> Cargar Cartera</span></a>
...
?>      
                      ...
                      <div class="modal-footer">
                        <a href="Informe-Cartera.php" class="btn btn-sm btn-danger" data-dismiss="modal">
                          <i class="ace-icon fa fa-times"></i>
                          Cancelar
                        </a>
...
<!-- <div class="widget-body">
		<h4 class="widget-title lighter">
			...
			<div class="row">
				<form action="Informe-Cartera.php?QueryCon=<?php Echo($TxtConsultaVen) ?>" method="post" id="FormFechas" autocomplete="off">
					<div class="col-xs-12 col-sm-6">
			...
			<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-info dropdown-menu-right">
													...
													if ($IdRol==1) {
														?>
														<li>
											<a style="position: relative;" data-rel="tooltip" data-placement="top" title="Editar Valores"  href="Informe-Cartera.php?NumeroFactura=<?php Echo($Id_Cartera) ?>&EditTask=1"><i class="fa fa-edit red "></i> Editar Valores</a>
													</li>
														<li class="divider"></li>
														<li>
