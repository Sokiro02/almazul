...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Agregar Proveedor Modasof</title>
...
<div>
	...
	<?php
$EditTask=$_GET['Addproveedor'];
$CodigoInsumo=$_GET['CodigoInsumo'];
...
?>
	...
	<form autocomplete="off" action="Insumo-AsociarProveedor.php" method="post" id="FormNuevoInsumo" enctype="multipart/form-data">
									
<input type="text" name="TxtCodigo" value="<?php Echo($CodigoInsumo)?>" style="display: none;">
<input type="text" name="TxtCategoria" value="<?php Echo($Qr_Id_CategoriaIns)?>" style="display: none;">
<input type="text" name="TxtUrl" value="<?php Echo($Qr_Url_Insumo)?>" style="display: none;">

									<div class="modal-dialog">
										<div class="modal-content ">
											<div class="modal-header">
												<a href="insumos.php" type="button" class="close" data-dismiss="modal">&times;</a>
												<h4 class="black bigger">Asociar Proveedores a Insumo </h4>
											</div>
	...
	$sql ="SELECT Id_Insumo, Cod_Insumo, Cod_Proveedor, Nom_Insumo, Unidad_Insumo, Proveedor_Id_Proveedor,Nom_Prov, Costo_Insumo FROM t_insumos as A, t_proveedores as E WHERE Cod_Insumo='".$CodigoInsumo."' and A.Proveedor_Id_Proveedor=E.Id_Proveedor"; 
//Echo($sql);
$result = $conexion->query($sql);
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        ...
        $Qr_Id_Proveedor=$row['Proveedor_Id_Proveedor'];
		 ...
		 ?>
									...
									<div class="form-group">
										<label for="form-field-select-3">Proveedor Asociado</label>

															<div>
								<select disabled="true" class="chosen-select input-xxlarge" name="TxtProveedor5" data-placeholder="Seleccionar...">
								...
								<div class="form-group">
															...
															<div>
													<input disabled="true" class="input-sm" type="text" id="demo5" placeholder="Costo Proveedor 1" name="demo1"  value="<?php Echo(formatomoneda($Qr_Costo_Insumo) )?>" required="true" />
													<input disabled="true" type="text" name="TxtCodProv5" class="input-sm" placeholder="Cód. Insumo Prov. 1" value="<?php Echo($Qr_Cod_Proveedor) ?>">
																</div>
																<script type="text/javascript">			
$("#demo1").maskMoney({
...
<?php 
 ...
 ?>
										...
										<div class="form-group">
										<label for="form-field-select-3">Agregar Proveedor 1</label>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
										...
										<div class="form-group">
										<label for="form-field-select-3">Agregar Proveedor 2</label>
...
symbolPosition : 'left' // use this setting to position the symbol at the left or right side of the value. default 'left'
										...
										<hr>
										<div class="form-group">
										<label for="form-field-select-3">Agregar Proveedor 3</label>
