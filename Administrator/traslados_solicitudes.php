...
$Datos="Ingreso a Aceptar Traslados de Referencias de la tienda: ".$Tienda;
		...
		<div class="page-content">
			...
			<!-- Inicio botones de acceso rápido -->
                ...
                <!-- Small boxes (Stat box) -->
                    ...
                    <h5 class="page-header">Seleccione la solicitud de tralado para mas detalles</h5>
                    <div class="row">
                        <table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                    	   <thead>
                    	       <tr class="warning">
                    					...
                    					<th class="tdcustom" style="width: 4%;">Fecha de Solicitud</th>
                    					<th class="tdcustom" style="width: 8%;">Tienda que Solicita</th>
                    					<th class="tdcustom" style="width: 8%;">Usuario que solicita</th>
                    		...
                    		<tbody>
                            <?php 
                                $sql = "SELECT * FROM t_traslados WHERE id_tienda_desde = '".$Tienda."' and status = 'SOLICITADO'";
                                ...
                                <tr>
                                    ...
                                    <td>
                						<div class=" action-buttons">
                							<a href="traslados_solicitudes_de.php?Traslado=<?php echo($id);?>" class="tooltip-error green" data-rel="tooltip" data-placement="top" title="Procesar traslado">
                								<i class="ace-icon fa fa-edit bigger-110"> </i> Procesar
                							</a>
                						</div>
                                    </td>
                                </tr>
