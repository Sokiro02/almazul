...
$sql ="SELECT Id_Insumo,Cod_Insumo, Nom_CategoriaIns,Categoria_Id_Categoria_Insumo, Nom_Insumo, Unidad_Insumo, Url_Insumo, Detalle_Insumo from t_insumos as A, t_categorias_insumos as B WHERE A.Categoria_Id_Categoria_Insumo=B.Id_Categoria_Insumo and Concatenar_Bus LIKE '%".$q."%' and Tipo_Insumo='2'"; 
//Echo($sql);
 ...
 ?>
										<li class="<?php echo($Nom_CategoriaIns);?>">
											     <?php
                                                    ...
                                                    ?>
							<img style="width: 120px; height: 120px;" alt="150x150" src="<?php echo $mostrar_img; ?>" data-name="<?php echo $Nom_Insumo; ?>" data-price="<?php echo $Promedio; ?>" data-foto="<?php echo ($Url_Insumo); ?>" data-unidad="<?php echo $Unidad_Insumo; ?>" class="img-responsive product_drag" />
...
url: "AgregarInsumosMaquilaAjax.php",//la url adonde se va a mandar la cadena a buscar
