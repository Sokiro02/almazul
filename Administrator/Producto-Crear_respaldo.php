...
<form action="Producto-GuardarReferencia.php" method="post" id="FormProducto" enctype="multipart/form-data" autocomplete="off">
...
<div class="col-sm-12 col-xs-12"> <!-- Inicio Campos Ref. Producto -->
 ...
 if ($result->num_rows > 0) {
  ...
  <input style="display: none;" type="text" name="Consecutivo_Prod" style="" value="<?php Echo($Consecutivo_Prod); ?>">
