					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="detalle-despachosinforme.php">Detalle Despachos</a>
							</li>
							<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-info">
														<li>
				<a  href="detalle-despachosinforme.php">Ver todas las tiendas</a>
			</li>
														<?php
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {   
    	...
    	?>
    		<li>
				<a  href="detalle-despachosinforme.php?QueryCon=<?php Echo($SelectDown);?>&Mensaje=27"><?php Echo utf8_encode($NomDown); ?></a>
			</li>
    	<?php
 }
}
...
<div class="widget-body">
		<h4 class="widget-title lighter">
			...
			<div class="row">
				<form action="detalle-despachosinforme.php?QueryCon=<?php Echo($TxtConsultaVen) ?>" method="post" id="FormFechas" autocomplete="off">
							...
							<table style="font-size: 12px;" id="dynamic-table"  class="table table-responsive table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <th class="success"></th>
												...
												<thead>
													...
													<th class="tdcustom" style="width: 10%;">Fecha <br><small>AAAA-MM-DD</small></th>
														<th class="tdcustom" style="width: 10%;">Enviado a</th>
														<th class="tdcustom" style="width: 10%;">Referencia</th>
														<th class="tdcustom" style="width: 10%;">Cant.</th>
														...
														<th class="tdcustom" style="width: 10%;">Costo</th>
															<th class="tdcustom" style="width: 13%;">%</th>
														
														
													</tr>
													<tr>
														<th class="tdcustom" style="width: 5%;">Id_Despacho</th>
														<th class="tdcustom" style="width: 10%;">Fecha<small>AAAA-MM-DD</small></th>
														<th class="tdcustom" style="width: 10%;">Enviado a</th>
														<th class="tdcustom" style="width: 10%;">Referencia</th>
														<th class="tdcustom" style="width: 10%;">Cant.</th>
														<th class="tdcustom" style="width: 10%;">¿Cliente?</th>
...
if ($TxtConsultaVen=='') {
$sql ="SELECT valor_total,id, id_tienda, nom_tienda, id_ref, img_ref, cod_ref, detalle_ref, talla_id, cantidad, valor_unidad, valor_total, fecha_ingreso, id_user, talla, status_recibido, codigo_generado, id_despacho, cliente, id_solicitud_prod, id_cliente_sol FROM t_temporal_inventario WHERE id='".$Cadena[$i]."'"; 
//Echo($sql);
$result = $conexion->query($sql);
}
else
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {                
        ...
        $id=$row['id'];
        $id_ref=$row['id_ref'];
        $consultareferencia=ObtenerCodRef($id_ref);
        ...
        $costoprenda=totalcostosReferencia($consultareferencia);

        $valorcosto=$costoprenda*$cantidad;

	}
}

if ($valor_total==0) {
	$UtilidadBruta="Revisar";
}
else
{

$Operacion1=((int)$valorcosto/(int) $valor_total);
...
$UtilidadBruta=$Operacion3;
						...
						<?php Echo($id); ?>
														...
														<td class="tdcustom">
															...
															<td class="tdcustom">
															<?php Echo strtoupper(utf8_encode($nom_tienda)) ?> <br>
														...
														<td>
															 <a target="_blank" href="Producto-modificar.php?RefSel=<?php Echo($consultareferencia); ?>" class="tooltip-success black" data-rel="tooltip" data-placement="top" title="Modificar Referencia"><i class="fa fa-edit bigger-130"></i></a>
															<?php echo (round($UtilidadBruta,2)) ?> %
														</td>
