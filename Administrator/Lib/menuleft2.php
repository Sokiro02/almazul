<ul class="nav nav-list">
 ...
 -->
					...
					if ($Menu_Insumos==1) {
						?>
						<li class="">
								<a href="Insumos-Productoterminado.php">
									<i class="menu-icon fa fa-user"></i>
									Insumo P. Terminado
								</a>
						<b class="arrow"></b>
                   ...
                   <li class="">
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                          ...
                          <li class="">
								<a href="tiendas_traslado_recibir.php">
									<i class="menu-icon fa fa-cogs"></i>
									Recibir Traslados
                                </a>
                                <b class="arrow"></b>
					...
					if ($Menu_CentroDist==1) {
						?>
							<li class="">
								<a href="Centro-Distribucion.php">
									<i class="menu-icon fa fa-cogs"></i>
					...
					if ($Menu_Bodegas==1) {
						?>
							<li class="">
								<a href="VerInventario-Tienda.php">
									<i class="menu-icon fa fa-line-chart"></i>
									Ver Inventarios 
								</a>
