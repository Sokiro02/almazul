...
$sql ="SELECT * FROM t_facturas WHERE Num_Factura='".$NumeroFactura."'";
	//Echo($sql);
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Crear Cambio Modasof</title>
...
<h5><img style="width: 15%;height: 15%;" class="nav-user-photo" src="../Administrator/<?php Echo utf8_encode(ObtenerfotoUsuario($Usuario_Vendedor)); ?>" alt="Jason's Photo" /> <?php Echo utf8_encode(ObtenernombreUsuario($Usuario_Vendedor)); ?></h5>
...
<div class="col-sm-4">
	<div class="widget-box">
		<div class="widget-body">
			<div class="widget-main">
<h5><i class="fa fa-user"></i>  Cliente:    <?php Echo utf8_encode(ObtenernombreCliente($Cliente_Id_Cliente)) ?> </h5>
