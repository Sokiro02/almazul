...
var dataString = 'palabra='+ texto;//se guarda en una variable nueva para posteriormente pasarla a busquedaMaquila.php
...
url: "busquedaMaquila.php",//la url adonde se va a mandar la cadena a buscar
data: dataString,
//cache: false,
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="Producto-CrearMaquila.php">Crear Referencia</a>
							</li>
						</ul><!-- /.breadcrumb -->
...
<form action="Producto-GuardarReferencia.php" method="post" id="FormProducto" enctype="multipart/form-data">
...
<div class="col-sm-12 col-xs-12"> <!-- Inicio Campos Ref. Producto -->
 ...
 if ($result->num_rows > 0) {
  ...
  ?></span>
  <input type="text" name="Consecutivo_Prod" style="display: none;" value="<?php Echo($Consecutivo_Prod); ?>">
  <input type="text" name="TipoReferencia" style="display: none;" value="2">
...
<div class="form-group col-sm-3 col-xs-12" id="Total">
       <label for="form-field-select-3">Total Costo Proyectado</label>
         <div>
         	<input class="input-xlarge" type="text" disabled="true" value="<?php Echo(formatomoneda($TotalCosto)) ?>" />
         </div>                       
</div>
<div class="form-group col-sm-3 col-xs-12">
...
?>  
  ...
  <div class="form-group col-sm-3 col-xs-12">
                              ...
                              <div>
                       <input type="text" name="TxtNomAnterior" class="input-xlarge">
                              </div>
  </div>
  <div class="form-group col-sm-6 col-xs-12">
                              ...
                              <div>
                       <input type="text" name="TxtDetalleAnterior" class="input-xxlarge">
                       
                       <input style="display: none;" type="text" name="FORMULARIO" value="MAQUILA">
                              </div>
  </div>
...
<div class="col-xs-12 col-sm-12">
	 <div class="form-group col-sm-6 col-xs-12">
      ...
      <div class="form-group col-sm-6 col-xs-12" style="margin-top: 12px;">
      		<button type="submit" class="btn btn-inverse btn-xlg">
      			<i style="margin: 10px;" class="fa fa-save"></i> Guardar Referencia
      		</button>
      </div>
</div>
