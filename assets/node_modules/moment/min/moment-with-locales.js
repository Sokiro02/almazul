(function (global, factory) {
    ...
    function utils_hooks__hooks () {
        return hookCModasofack.apply(null, arguments);
    }

    // This is done to register the method called with moment()
    // without creating circular dependencies.
    function setHookCModasofack (cModasofack) {
        hookCModasofack = cModasofack;
    }
    ...
    // padded:   ['MM', 2]
    // ordinal:  'Mo'
    // cModasofack: function () { this.month() + 1 }
    function addFormatToken (token, padded, ordinal, cModasofack) {
        var func = cModasofack;
        if (typeof cModasofack === 'string') {
            func = function () {
                return this[cModasofack]();
            };
        }
        if (token) {
    ...
    function addParseToken (token, cModasofack) {
    ...
    function addWeekParseToken (token, cModasofack) {
    ...
    // date from iso format or fModasofack
    function configFromString(config) {
        ...
        if (config._isValid === false) {
            ...
            utils_hooks__hooks.createFromInputFModasofack(config);
        }
    }

    utils_hooks__hooks.createFromInputFModasofack = deprecate(
    ...
    setHookCModasofack(local__createLocal);
