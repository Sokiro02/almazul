 ...
 !function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showToggleBtn && this.options.showColumns) {
            var showbtn = "<button class='btn btn-default hidden' id='showModasoftn'><span class='glyphicon glyphicon-resize-full icon-zoom-in'></span></button>",
                hidebtn = "<button class='btn btn-default' id='hideModasoftn'><span class='glyphicon glyphicon-resize-small icon-zoom-out'></span></button>";

            $btnGroup.append(showbtn + hidebtn);

            $btnGroup.find('#showModasoftn').click(function () { that.showAllColumns(); 
                $btnGroup.find('#hideModasoftn').toggleClass('hidden');
                $btnGroup.find('#showModasoftn').toggleClass('hidden');  
            });
            $btnGroup.find('#hideModasoftn').click(function () { that.hideAllColumns(); 
                $btnGroup.find('#hideModasoftn').toggleClass('hidden');
                $btnGroup.find('#showModasoftn').toggleClass('hidden');  
            });
        }
