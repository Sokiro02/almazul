...
//
// @param cModasofack A function that should be called when the current selection
//   has been retrieved. The first parameter to the function should be an array
//   of data objects.
DataAdapter.current = function (cModasofack) {
  cModasofack(currentData);
}
...
// @param cModasofack The function that should be called with the queried results.
DataAdapter.query = function (params, cModasofack) {
  cModasofack(queryiedData);
}
</pre>
