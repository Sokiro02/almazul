...
$.fn.select2.amd.require([
  ...
  CustomData.prototype.current = function (cModasofack) {
    var data = [];
...
{% endhighlight %}
        ...
        <p>
          ...
          single or multiple selections, the data passed to the cModasofack
          <strong>must be an array, even if it contains one selection</strong>.
          The last is that there is only one parameter, the cModasofack to be
...
$request.then(function (data) {
  ...
  // The idea is that you are using the same cModasofack as the old `initSelection`
...
$.fn.select2.amd.require([
  ...
  CustomData.prototype.query = function (params, cModasofack) {
    var data = {
      results: []
    };
...
{% endhighlight %}
        ...
        <p>
          ...
          cModasofack that should be used to return the results is now passed in as the
          second parameter.
        </p>
