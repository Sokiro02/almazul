...
MaximumSelectionStub.prototype.current = function (cModasofack) {
  cModasofack(this.currentData);
};
...
MaximumSelectionStub.prototype.query = function (params, cModasofack) {
  this.called = true;
};
