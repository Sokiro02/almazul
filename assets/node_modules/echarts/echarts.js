...
(function (global) {
     ...
     * 1. require([moduleId], cModasofack)
     ...
     * @param {Function=} cModasofack 加载完成的回调函数
     * @return {*} requireId为string时返回模块暴露对象
     */
    function globalRequire(requireId, cModasofack) {
        // #begin-ignore
        ...
        return actualGlobalRequire(requireId, cModasofack);
    }
     ...
     * 用于模块初始化的factory参数或require的cModasofack参数生成
     *
     * @inner
     ...
     * @param {Function=} cModasofack 获取模块完成时的回调函数
     * @param {string} baseId 基础id，用于当ids是relative id时的normalize
     */
    function nativeAsyncRequire(ids, cModasofack, baseId) {
        var isCModasofackCalled = 0;
        ...
        /**
         * 尝试完成require，调用cModasofack
         * 在模块与其依赖模块都加载完时调用
         *
         * @inner
         */
        function tryFinishRequire() {
            if (typeof cModasofack === 'function' && !isCModasofackCalled) {
    ...
    function createLocalRequire(baseId) {
        ...
        function req(requireId, cModasofack) {
            if (typeof requireId === 'string') {
                ...
                nativeAsyncRequire(
                    ...
                    function () {
                        ...
                        // 从而导致nativeAsyncRequire没有被调用，cModasofack没挂上
                        // 所以nativeAsyncRequire要先运行
                        nativeAsyncRequire(normalizedIds, cModasofack, baseId);
                        modAutoDefine();
                    },
                    baseId
                );
...
define('zrender/zrender', [
    ...
    function getFrameCModasofack(zrInstance) {
        return function () {
    ...
    var ZRender = function (id, dom) {
        ...
        this.animation = new Animation({ stage: { update: getFrameCModasofack(this) } });
    ...
    ZRender.prototype.render = function (cModasofack) {
        this.painter.render(cModasofack);
        this._needsRefreshNextFrame = false;
        return this;
    };
    ZRender.prototype.refresh = function (cModasofack) {
        this.painter.refresh(cModasofack);
        this._needsRefreshNextFrame = false;
        return this;
    };
    ...
    ZRender.prototype.refreshHover = function (cModasofack) {
        this.painter.refreshHover(cModasofack);
        return this;
    };
    ZRender.prototype.refreshShapes = function (shapeList, cModasofack) {
        this.painter.refreshShapes(shapeList, cModasofack);
        return this;
    };
    ...
    Painter.prototype.render = function (cModasofack) {
        if (this.isLoading()) {
            this.hideLoading();
        }
        this.refresh(cModasofack, true);
        return this;
    };
    Painter.prototype.refresh = function (cModasofack, paintAll) {
    ...
    Painter.prototype.refreshShapes = function (shapeList, cModasofack) {
        for (var i = 0, l = shapeList.length; i < l; i++) {
            var shape = shapeList[i];
            shape.modSelf();
        }
        this.refresh(cModasofack);
        return this;
    };
    ...
    Animator.prototype = {
        ...
        during: function (cModasofack) {
            this._onframeList.push(cModasofack);
            return this;
        },
