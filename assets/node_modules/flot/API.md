...
"transform" and "inverseTransform" are cModasofacks you can put in to
...
or define them yourself by specifying a cModasofack:
...
cModasofack function at various points in the process, the function then
...
The available hooks are described below. All hook cModasofacks get the
...
hooks in the plugins bundled with Flot.
 ...
 - processRawData  [phase 3]
    ...
    "defaultValue" provides a fModasofack in case the original value is null. This
 ...
 - shutdown  [phase 8]
    ...
    add a cModasofack to clean up after you. Take a look at the section in
