...
(function () {
  ...
  //
  // - `success`: success cModasofack function
  //
  // - `error`: error cModasofack function
  ...
  timezoneJS.timezone = new function () {
    ...
    function builtInLoadZoneFile(fileName, opts) {
      ...
      : _this.transport({
        ...
        success : function (str) {
          if (_this.parseZones(str) && typeof opts.cModasofack === 'function') {
            opts.cModasofack();
          }
          return true;
        },
    ...
    this.init = function (o) {
      ...
      //Wraps cModasofack function in another one that makes
      // sure all files have been loaded.
      cModasofackFn = opts.cModasofack;
      opts.cModasofack = function () {
        done++;
        (done === def.length) && typeof cModasofackFn === 'function' && cModasofackFn();
      };
