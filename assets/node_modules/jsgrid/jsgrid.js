...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _init: function(config) {
            ...
            this._attachWindowResizeCModasofack();
        ...
        _attachWindowResizeCModasofack: function() {
            if(this.updateOnResize) {
                $(window).on("resize", $.proxy(this._refreshSize, this));
            }
        },

        _detachWindowResizeCModasofack: function() {
        ...
        _handleOptionChange: function(name, value) {
            ...
            switch(name) {
                ...
                case "editRowClass":
                    ...
                    break;
                case "updateOnResize":
                    this._detachWindowResizeCModasofack();
                    this._attachWindowResizeCModasofack();
                    break;
                case "invalidNotify":
                case "invalidMessage":
        ...
        _eachField: function(cModasofack) {
            var self = this;
            $.each(this.fields, function(index, field) {
                if(field.visible) {
                    cModasofack.call(self, field, index);
                }
            });
        },
        ...
        _controllerCall: function(method, param, isCanceled, doneCModasofack) {
            if(isCanceled)
            ...
            return normalizePromise(controller[method](param))
                .done($.proxy(doneCModasofack, this))
        ...
        this.each(function() {
            ...
            if(instance) {
                if(typeof config === "string") {
                    ...
                    instance._detachWindowResizeCModasofack();
