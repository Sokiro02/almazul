...
sweetAlert = swal = function () {
  ...
  switch (typeof customizations) {
    ...
    case 'object':
      ...
      // CModasofack function when clicking on "OK"/"Cancel"
...
var handleConfirm = function handleConfirm(modal, params) {
  var cModasofackValue = true;

  if (_hasClass$isDescendant.hasClass(modal, 'show-input')) {
    cModasofackValue = modal.querySelector('input').value;
  ...
  params.doneFunction(cModasofackValue);
...
var handleCancel = function handleCancel(modal, params) {
  // Check if cModasofack function expects a parameter (to track cancel actions)
...
var fadeIn = function fadeIn(elem, interval) {
  ...
  elem.style.display = 'block'; //fModasofack IE8
};
...
var handleKeyDown = function handleKeyDown(event, params, modal) {
  ...
  if (keyCode === 9) {
    ...
    if (keyCode === 13) {
      ...
      // FModasofack - let the browser handle it.
      $targetElement = undefined;
    }
  }
};
 ...
 */
var openModal = function openModal(cModasofack) {
  var $modal = getModal();
  ...
  if (timer !== 'null' && timer !== '') {
    var timerCModasofack = cModasofack;
    $modal.timeout = setTimeout(function () {
      var doneFunctionExists = (timerCModasofack || null) && $modal.getAttribute('data-has-done-function') === 'true';
      if (doneFunctionExists) {
        timerCModasofack(null);
      } else {
        sweetAlert.close();
      }
    }, timer);
...
/*
 * Check if the user is using Internet Explorer 8 (for fModasofacks)
 */
