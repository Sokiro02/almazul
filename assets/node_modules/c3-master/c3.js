...
c3_chart_internal_fn.redraw = function (options, transitions) {
    ...
    if ((duration || flow) && $$.isTabVisible()) {
        ...
        d3.transition().duration(duration).each(function () {
            ...
            // Wait for end of transitions to call flow and onrendered cModasofack
...
c3_chart_internal_fn.bindResize = function () {
    ...
    if (window.attachEvent) {
        ...
        // fModasofack to this, if this is a very old browser
...
c3_chart_internal_fn.endall = function (transition, cModasofack) {
    var n = 0;
    transition.each(function () {
        ++n;
    }).each("end", function () {
        if (! --n) {
            cModasofack.apply(this, arguments);
        }
    });
};
c3_chart_internal_fn.generateWait = function () {
    var transitionsToWait = [],
        f = function f(transition, cModasofack) {
...
c3_chart_internal_fn.generateColor = function () {
    ...
    return function (d) {
        ...
        // if cModasofack function is provided
        ...
        return cModasofack instanceof Function ? cModasofack(color, d) : color;
    };
};
...
c3_chart_internal_fn.drag = function (mouse) {
    ...
    main.selectAll('.' + CLASS.shapes).selectAll('.' + CLASS.shape).filter(function (d) {
        ...
        if (isWithin ^ isIncluded) {
            ...
            // TODO: included/unincluded cModasofack here
