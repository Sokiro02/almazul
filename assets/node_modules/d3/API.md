...
Separate concerns using named cModasofacks.
...
* [*queue*.await](https://github.com/d3/d3-queue/blob/master/README.md#queue_await) - register a cModasofack for when tasks complete.
* [*queue*.awaitAll](https://github.com/d3/d3-queue/blob/master/README.md#queue_awaitAll) - register a cModasofack for when tasks complete.
...
* [*timer*.restart](https://github.com/d3/d3-timer/blob/master/README.md#timer_restart) - reset the timer’s start time and cModasofack.
...
* [d3.timeout](https://github.com/d3/d3-timer/blob/master/README.md#timeout) - schedule a timer that stops on its first cModasofack.
