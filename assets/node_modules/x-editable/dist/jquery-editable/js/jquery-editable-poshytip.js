        ...
        **/        
        ...
        submit: function(e) {
            ...
            .done($.proxy(function(response) {
                ...
                //run success cModasofack
                var res = typeof this.options.success === 'function' ? this.options.success.call(this.options.scope, response, newValue) : null;

                //if success cModasofack returns false --> keep form open and do not activate input
                if(res === false) {
                    this.error(false);
                    this.showForm(false);
                    return;
                ...
                //if success cModasofack returns string -->  keep form open, show error and activate input               
                ...
                //if success cModasofack returns object like {newValue: <something>} --> use that value instead of submitted
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        If function - it will be called instead of ajax. Function should return deferred object to run fail/done cModasofacks.
        ...
        **/         
        validate: null,
        /**
        Success cModasofack. Called when value successfully sent on server and **response status = 200**.  
        Usefull to work with json response. For example, if your backend response can be <code>{success: true}</code>
        or <code>{success: false, msg: "server error"}</code> you can check it inside this cModasofack.  
        ...
        **/          
        success: null,
        /**
        Error cModasofack. Called when request failed (response status != 200).  
        ...
        **/         
        showbuttons: true,
        /**
        Scope for cModasofack methods (success, validate).  
...
(function ($) {
    ...
    Popup.prototype = {
        ...
        init: function(element, options) {
            ...
            //set scope of form cModasofacks to element
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //also we set scope option to have access to element inside input specific cModasofacks (e. g. source as function)
        ...
        */          
        render: function(response) {
            ...
            //if input has `value2htmlFinal` method, we pass cModasofack in third param to be called when source is loaded
    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **/
        value: null,
        /**
        CModasofack to perform custom displaying of value in element's text.  
            ...
            if (typeof source === 'string') {
                ...
                if(this.options.sourceCache) {
                    ...
                    if (cache.loading === false && cache.sourceData) { //take source from cache
                        ...
                        success.call(this);
                        return;
                    } else if (cache.loading === true) { //cache is loading, put cModasofack in stack to be called later
                        cache.cModasofacks.push($.proxy(function () {
                            this.sourceData = cache.sourceData;
                            this.doPrepend();
                            success.call(this);
                        }, this));

                        //also collecting error cModasofacks
                        cache.err_cModasofacks.push($.proxy(error, this));
                        return;
                    } else { //no cache yet, activate it
                        cache.loading = true;
                        cache.cModasofacks = [];
                        cache.err_cModasofacks = [];
                    }
                }
                ...
                var ajaxOptions = $.extend({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        if($.isArray(this.sourceData)) {
                            if(cache) {
                                ...
                                //run success cModasofacks for other fields waiting for this source
                                $.each(cache.cModasofacks, function () { this.call(); }); 
                            }
                            this.doPrepend();
                            success.call(this);
                        } else {
                            error.call(this);
                            if(cache) {
                                //run error cModasofacks for other fields waiting for this source
                                $.each(cache.err_cModasofacks, function () { this.call(); }); 
                            }
                        }
                    }, this),
                    error: $.proxy(function () {
                        ...
                        if(cache) {
                             cache.loading = false;
                             //run error cModasofacks for other fields
                             $.each(cache.err_cModasofacks, function () { this.call(); }); 
                        }
                    }, this)
...
$(function(){
    ...
    $('#country').editable({
        select2: {
            ...
            initSelection: function (element, cModasofack) {
    ...
    */ 
    ...
    if($.Poshytip) {  //need this check, because in inline mode poshytip may not be loaded!
      ...
      $.Poshytip.prototype.refresh = function(async) {
          ...
          var $table = this.$tip.find('table.fModasofack');
          if (ie6) {
