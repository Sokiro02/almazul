...
(function(factory) {
    ...
    */
    ...
    GridStackDragDropPlugin.prototype.on = function(el, eventName, cModasofack) {
        return this;
    };
    ...
    GridStack.prototype._updateElement = function(el, cModasofack) {
        el = $(el).first();
        var node = el.data('_gridstack_node');
        if (typeof node == 'undefined' || node === null) {
            return;
