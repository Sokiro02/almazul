...
(function(global, factory) {
  ...
  function(_jquery) {
    ...
    function emulateTransitionEnd($el, duration) {
      ...
      var cModasofack = function cModasofack() {
        if (!called) {
          $el.trigger(support.transition.end);
        }
      };
      setTimeout(cModasofack, duration);
    }
    ...
    var Step = function() {
      ...
      _createClass(Step, [{
        ...
        key: 'show',
        value: function show(cModasofack) {
          ...
          var complete = function complete() {
            ...
            if (_jquery2.default.isFunction(cModasofack)) {
              cModasofack.call(this);
            }
          };
        ...
        key: 'hide',
        value: function hide(cModasofack) {
          if (this.is('activing') || !this.is('active')) {
        ...
        key: 'load',
        value: function load(cModasofack) {
          var that = this;
    ...
    var wizard = function() {
      ...
      _createClass(wizard, [{
        ...
        key: 'goTo',
        value: function goTo(index, cModasofack) {
