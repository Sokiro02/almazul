  ...
  describe("Dropzone", function() {
    ...
    describe("Emitter", function() {
      ...
      it(".on() should properly register listeners", function() {
        var cModasofack, cModasofack2;
        (emitter._cModasofacks === void 0).should.be["true"];
        cModasofack = function() {};
        cModasofack2 = function() {};
        emitter.on("test", cModasofack);
        emitter.on("test", cModasofack2);
        emitter.on("test2", cModasofack);
        emitter._cModasofacks.test.length.should.equal(2);
        emitter._cModasofacks.test[0].should.equal(cModasofack);
        emitter._cModasofacks.test[1].should.equal(cModasofack2);
        emitter._cModasofacks.test2.length.should.equal(1);
        return emitter._cModasofacks.test2[0].should.equal(cModasofack);
      });
      it(".emit() should return the object itself", function() {
        return emitter.emit('test').should.equal(emitter);
      });
      it(".emit() should properly invoke all registered cModasofacks with arguments", function() {
        var callCount1, callCount12, callCount2, cModasofack1, cModasofack12, cModasofack2;
        callCount1 = 0;
        callCount12 = 0;
        callCount2 = 0;
        cModasofack1 = function(var1, var2) {
          callCount1++;
          var1.should.equal('cModasofack1 var1');
          return var2.should.equal('cModasofack1 var2');
        };
        cModasofack12 = function(var1, var2) {
          callCount12++;
          var1.should.equal('cModasofack1 var1');
          return var2.should.equal('cModasofack1 var2');
        };
        cModasofack2 = function(var1, var2) {
          callCount2++;
          var1.should.equal('cModasofack2 var1');
          return var2.should.equal('cModasofack2 var2');
        };
        emitter.on("test1", cModasofack1);
        emitter.on("test1", cModasofack12);
        emitter.on("test2", cModasofack2);
        callCount1.should.equal(0);
        callCount12.should.equal(0);
        callCount2.should.equal(0);
        emitter.emit("test1", "cModasofack1 var1", "cModasofack1 var2");
        callCount1.should.equal(1);
        callCount12.should.equal(1);
        callCount2.should.equal(0);
        emitter.emit("test2", "cModasofack2 var1", "cModasofack2 var2");
        callCount1.should.equal(1);
        callCount12.should.equal(1);
      ...
      return describe(".off()", function() {
        var cModasofack1, cModasofack2, cModasofack3, cModasofack4;
        cModasofack1 = function() {};
        cModasofack2 = function() {};
        cModasofack3 = function() {};
        cModasofack4 = function() {};
        beforeEach(function() {
          return emitter._cModasofacks = {
            'test1': [cModasofack1, cModasofack2],
            'test2': [cModasofack3],
            'test3': [cModasofack1, cModasofack4],
            'test4': []
          };
        });
        it("should work without any listeners", function() {
          var emt;
          emitter._cModasofacks = void 0;
          emt = emitter.off();
          emitter._cModasofacks.should.eql({});
        ...
        it("should properly remove all event listeners for specific event", function() {
          var emt;
          emitter.off("test1");
          (emitter._cModasofacks["test1"] === void 0).should.be["true"];
          emitter._cModasofacks["test2"].length.should.equal(1);
          emitter._cModasofacks["test3"].length.should.equal(2);
          emt = emitter.off("test2");
          (emitter._cModasofacks["test2"] === void 0).should.be["true"];
          return emt.should.equal(emitter);
        });
        return it("should properly remove specific event listener", function() {
          var emt;
          emitter.off("test1", cModasofack1);
          emitter._cModasofacks["test1"].length.should.equal(1);
          emitter._cModasofacks["test1"][0].should.equal(cModasofack2);
          emitter._cModasofacks["test3"].length.should.equal(2);
          emt = emitter.off("test3", cModasofack4);
          emitter._cModasofacks["test3"].length.should.equal(1);
          emitter._cModasofacks["test3"][0].should.equal(cModasofack1);
          return emt.should.equal(emitter);
        });
      });
    });
    describe("static functions", function() {
      ...
      return describe("Dropzone.confirm", function() {
        ...
        it("should forward to window.confirm and call the cModasofacks accordingly", function() {
    ...
    describe("constructor()", function() {
      ...
      return describe("options", function() {
        ...
        it("should call the fModasofack function if forceFModasofack == true", function(done) {
          return dropzone = new Dropzone(element, {
            url: "/some/other/url",
            forceFModasofack: true,
            fModasofack: function() {
              return done();
            }
          });
        });
    ...
    describe("helper function", function() {
      ...
      describe("getExistingFModasofack()", function() {
        it("should return undefined if no fModasofack", function() {
          return expect(dropzone.getExistingFModasofack()).to.equal(void 0);
        });
        it("should only return the fModasofack element if it contains exactly fModasofack", function() {
          element.appendChild(Dropzone.createElement("<form class=\"fModasofacks\"></form>"));
          element.appendChild(Dropzone.createElement("<form class=\"sfModasofack\"></form>"));
          return expect(dropzone.getExistingFModasofack()).to.equal(void 0);
        });
        it("should return divs as fModasofack", function() {
          var fModasofack;
          fModasofack = Dropzone.createElement("<form class=\" abc fModasofack test \"></form>");
          element.appendChild(fModasofack);
          return fModasofack.should.equal(dropzone.getExistingFModasofack());
        });
        return it("should return forms as fModasofack", function() {
          var fModasofack;
          fModasofack = Dropzone.createElement("<div class=\" abc fModasofack test \"></div>");
          element.appendChild(fModasofack);
          return fModasofack.should.equal(dropzone.getExistingFModasofack());
        });
      });
      describe("getFModasofackForm()", function() {
        it("should use the paramName without [0] if uploadMultiple is false", function() {
          var fModasofack, fileInput;
          dropzone.options.uploadMultiple = false;
          dropzone.options.paramName = "myFile";
          fModasofack = dropzone.getFModasofackForm();
          fileInput = fModasofack.querySelector("input[type=file]");
    ...
    return describe("file handling", function() {
      ...
      describe("addFile()", function() {
        ...
        return describe("thumbnails", function() {
          it("should properly queue the thumbnail creation", function(done) {
            var ct_cModasofack, ct_file, doneFunction, mock1, mock2, mock3;
            doneFunction = null;
            dropzone.accept = function(file, done) {
              return doneFunction = done;
            };
            ...
            ct_file = ct_cModasofack = null;
            dropzone.createThumbnail = function(file, cModasofack) {
              ct_file = file;
              return ct_cModasofack = cModasofack;
            };
      ...
      describe("uploadFiles()", function() {
        ...
        it("should ignore the onreadystate cModasofack if readyState != 4", function(done) {
          dropzone.addFile(mockFile);
          return setTimeout(function() {
