...
$.fn.dataTableExt.oPagination.ellipses = {
    ...
    'fnClickHandler': function(e) {
        var fnCModasofackDraw = e.data.fnCModasofackDraw,
        ...
        fnCModasofackDraw(oSettings);

        return true;
    },
    // fnInit is called once for each instance of pager
    'fnInit': function(oSettings, nPager, fnCModasofackDraw) {
        ...
        oFirst.click({ 'fnCModasofackDraw': fnCModasofackDraw, 'oSettings': oSettings, 'sPage': 'first' }, that.fnClickHandler);
        oPrevious.click({ 'fnCModasofackDraw': fnCModasofackDraw, 'oSettings': oSettings, 'sPage': 'previous' }, that.fnClickHandler);
        oNext.click({ 'fnCModasofackDraw': fnCModasofackDraw, 'oSettings': oSettings, 'sPage': 'next' }, that.fnClickHandler);
        oLast.click({ 'fnCModasofackDraw': fnCModasofackDraw, 'oSettings': oSettings, 'sPage': 'last' }, that.fnClickHandler);

        // Draw
        $(nPager).append(oFirst, oPrevious, oNumbers, oNext, oLast);
    },
    // fnUpdate is only called once while table is rendered
    'fnUpdate': function(oSettings, fnCModasofackDraw) {
        var oClasses = oSettings.oClasses,
            that = this;
        ...
        for (i = oSettings._iFirstPage; i <= oSettings._iLastPage; i++) {
            ...
            if (oSettings._iCurrentPage === i) {
                ...
                oNumber.click({ 'fnCModasofackDraw': fnCModasofackDraw, 'oSettings': oSettings, 'sPage': i - 1 }, that.fnClickHandler);
            }
