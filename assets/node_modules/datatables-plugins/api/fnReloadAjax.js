 ...
 *  @param {function} [fnCModasofack] CModasofack that is executed when the table has
...
jQuery.fn.dataTableExt.oApi.fnReloadAjax = function ( oSettings, sNewSource, fnCModasofack, bStandingRedraw )
{
	...
	if ( jQuery.fn.dataTable.versionCheck ) {
		...
		if ( sNewSource ) {
			api.ajax.url( sNewSource ).load( fnCModasofack, !bStandingRedraw );
		}
		else {
			api.ajax.reload( fnCModasofack, !bStandingRedraw );
		}
		return;
	}
	...
	oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
		...
		/* CModasofack user function - for event handlers etc */
		if ( typeof fnCModasofack == 'function' && fnCModasofack !== null )
		{
			fnCModasofack( oSettings );
		}
	}, oSettings );
};
